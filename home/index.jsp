	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100">
				...
				<div class="login100-pic js-tilt p-l-0 p-r-0 p-t-180" data-tilt>

					<img id="logopics" src="../images/logo.png" alt="IMG">
				...
				<form class="login100-form validate-form p-l-45 p-r-35 p-t-120"  style="background-color: #FEFCEF;" method="post" id="logIn">
					<span class="login100-form-titles">
						Login
					</span>
					<%if(!sessmsg.equals("")) {%>
					...
					<div class="text-center linksreset">
						<a href="../admin/frm_admin_release_lock2.jsp">RESET NOW</a>
					</div>
