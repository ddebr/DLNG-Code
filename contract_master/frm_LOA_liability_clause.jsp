...
<html>
<head>
<title>DLNG | LOA Liability Clause Details</title>
<meta charset="utf-8">
...
function doSubmit()
{
	...
	if(flag1)
	{
		var a = confirm("Do You Want To Submit Data Regarding Letter of Agreement Liablity Clause ???");	
		if(a)
		{
...
function setvalues(price_per1,price1,promise_qty1,lower_per1,dcq,pndcq,mdcq,remarks1,price_per2,price2,top_per,actual_oblig,promise_qty2,remarks2,makeup_period ,rec_period,price_per3,price3,remarks3,ld_from_dt,ld_to_dt,top_from_dt,top_to_dt)
{
	...
	document.forms[0].ld_from_dt.value=ld_from_dt;
	document.forms[0].ld_to_dt.value=ld_to_dt;
	...
	document.forms[0].top_from_dt.value=top_from_dt;
	document.forms[0].top_to_dt.value=top_to_dt;
...
<%
     ...
     masCont.setCallFlag("LOA_LIABILITY_CLAUSE");
	 ...
	 //price1=nf.format(Double.parseDouble(price1));
	 //price2=nf.format(Double.parseDouble(price2));
	 //price3=nf.format(Double.parseDouble(price3));
	 //String x="";
	 utilBean.init();
%>  

<body onload="setvalues('<%=price_per1%>','<%=price1%>','<%=promise_qty1 %>','<%=lower_per1 %>','<%=dcq %>','<%=pndcq %>','<%=mdcq %>',&quot;<%=remarks1 %>&quot;,'<%=price_per2 %>','<%=price2 %>','<%=top_per %>','<%=actual_oblig%>','<%=promise_qty2 %>',&quot;<%=remarks2 %>&quot;,'<%=makeup_period %>','<%=rec_period %>','<%=price_per3 %>','<%=price3%>',&quot;<%=remarks3%>&quot;,'<%=ld_from_dt%>','<%=ld_to_dt%>','<%=top_from_dt%>','<%=top_to_dt%>');setComponent('<%=LD%>','<%=TOP%>','<%=MAKEUP%>');">
					...
					<tbody>
						<tr>
							...
							<td colspan="5">
	     					...
	     					<td>
	     						<input type="text" name="price1" maxlength="8" size="8" value="" onblur="checkNumber1(this,6,4);" readonly="readonly">
	     					</td>
						</tr>
						<tr>   
							<td align="left" class="info"><strong>Promise Quantity On</strong></td>
					     	...
					     	<td>
						     	<strong>From</strong>
	                			<input type="text" name="ld_from_dt" id="datetimepicker1" size="10" maxlength="10" value="<%=ld_from_dt%>" onBlur="validateDate(this);">
	                		</td>
	                		<td>
	                			<strong>To</strong>
	                			<input type="text" name="ld_to_dt" id="datetimepicker2" size="10" maxlength="10" value="<%=ld_to_dt%>" onBlur="validateDate(this);">
	                		</td>	
			         	</tr>
						<tr>   
						...
						<tr >   
							...
							<td align="left" > <input type=text name=price2 maxlength=8 size=8 value="" onblur="checkNumber1(this,6,4);"  readonly="readonly"></td>
						</tr>
						<tr >   
							<td align="left" class="info"><strong>Take or Pay </strong></td>
						 	<td align="left" colspan="11"> <input type=text name=top_percentage maxlength=8 size=5 value="" onblur="checkNumber1(this,5,2);calcObligation();">&nbsp;
						...
						<tr>   
							<td align="left" class="info"><strong>Promise Quantity On</strong></td>
					     	...
					     	<td>
						     	<strong>From</strong>
	                			<input type="text" name="top_from_dt" id="datetimepicker3" size="10" maxlength="10" value="<%=top_from_dt%>" onBlur="validateDate(this);">
	                		</td>
	                		<td>
	                			<strong>To</strong>
	                			<input type="text" name="top_to_dt" id="datetimepicker4" size="10" maxlength="10" value="<%=top_to_dt%>" onBlur="validateDate(this);">
	                		</td>	
			         	</tr>
			         	 <tr>   
							 <td align="left" class="info"><strong>Remarks</strong></td>
						...
						<tr >   
				         ...
				         <tr >   
							 ...
							 <td align="left" class="info"><strong>Effective Price ($/MMBTU)</strong></td>
							 <td align="left" ><input type=text name=price3 maxlength=8 size=8 value="" onblur="checkNumber1(this,6,4);" class="mkrdly" readonly></td>
						 </tr> 
						 <tr >   
							 <td align="left" class="info"><strong>Remarks</strong></td>
...
<input type=hidden name="option"  value="LOA_LIABILITY">
