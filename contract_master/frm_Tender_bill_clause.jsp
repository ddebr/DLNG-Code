...
<html>
<head>
<title>DLNG | Tender Billing Clause Details</title>
...
function doSubmit(fgsa_cd,fgsa_rev_no)
{
	...
	document.forms[0].option.value="Tender_BillingDetail";
	...
	if(flag1)
	{
		var a = confirm("Do You Want To Submit Data Regarding This Tender Bill Clause ???");	
		if(a)
		{
...
<%
	...
	masOthers.setCallFlag("Tender_Billing_Dtl");
	masOthers.init();
	...
	<div class="tab-pane active" id="">
		<div class="box mb-0">
			<form method="post" action="../servlet/Frm_Contract_MasterV2">
				...
				<input name="option" type="hidden" value="Tender_BillingDetail">
					...
					<div class="row">
						<div class="table-responsive col-lg-12">
							<table class="table table-striped" >
								<thead>   
									<tr><th colspan="7" class="info text-center"><b><%=cust_abr%>[<%=FGSA_No %>-0]: Billing Details</b></th></tr>
									<tr>
