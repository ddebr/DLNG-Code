...
<html>
<head>
<title>DLNG | Tender Liability Clause Details</title>
...
function doSubmit()
{
	...
	if(flag1)
	{
		var a = confirm("Do You Want To Submit Data Regarding This Tender Liability Clause ???");	
		if(a)
		{
...
<%	}
	...
	String audit_permission = request.getParameter("audit_permission")==null?"N":request.getParameter("audit_permission");
	 ...
	 masCont.setCallFlag("Tender_LIABILITY_CLAUSE");
					...
					<table class="table table-striped" >
						...
						<tbody>
							<tr>
								...
								<td colspan="11">
									<input type=text name="percentage1" maxlength=8 size=8 value="" onblur="checkNumber1(this,5,2);"> <b>%</b>
			 						<input type=hidden name="price1" maxlength=8 size=8 value="0"> 
		     					</td>
							</tr>
							<tr>   
				         	...
				         	<tr >   
								<td class="info"><strong>Liability At</strong> </td>
							 	<td > Lower Of&nbsp; <input type=text name=low_percentage maxlength=8 size=5 value="" onblur="checkNumber1(this,5,2);">&nbsp;%&nbsp;&nbsp;Of			     
							...
							<tr >   
						 		...
						 		<td align="left" colspan="11"> 
						 			<input type=text name="percentage2" maxlength=8 size=8 value="" onblur="checkNumber1(this,5,2);">&nbsp;<b>%</b>
						 			<input type=hidden name="price2" maxlength=8 size=8 value="0">
					     		</td>
				         	</tr>
				         	
				         	<tr >   
								<td class="info"><strong>Take or Pay </strong></td>
							 	<td align="left" colspan="11"><input type=text name=top_percentage maxlength=8 size=5 value="" onblur="checkNumber1(this,5,2);">&nbsp;<b>%&nbsp;&nbsp;of DCQ/TCQ</b></td>
				         	</tr>          
				         	<tr >   
							 	<td class="info"><strong>Actual obligation to take </strong></td>
							 	<td align="left" colspan="11"><input type=text name=obligation maxlength=11 size=8 value="" onblur="checkNumber1(this,10,2);">&nbsp;(MMBTU)</td>
				         	</tr> 
				         	<tr>   
								<td align="left" class="info"><strong>Promise Quantity On</strong></td>
								<td align="left" colspan="11"> 
							...
							<tr >   
					         ...
					         <tr >   
								 <td align="left" class="info"><strong>Price (% of Contract Price)</strong></td>
								 <td align="left" colspan="11"><input type=text name="percentage3" maxlength=8 size=8 value="" onblur="checkNumber1(this,4,2);"> <b>%</b><input type=hidden name="price3" maxlength=8 size=8 value="0"> </td>
							 </tr> 
					         <tr >   
								 <td align="left" class="info"><strong>Remarks</strong></td>
...
<input type=hidden name="option"  value="TENDER_LIABILITY">
