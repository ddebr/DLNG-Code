...
<html>
<head>
<title>DLNG | SN Billing Clause Details</title>
...
function doSubmit(fgsa_cd,fgsa_rev_no)
{
	...
	var due_dt_calc = document.forms[0].due_dt_calc.value;
	...
	document.forms[0].option.value="SN_BillingDetail";
	...
	if(due_dt_calc == '' || due_dt_calc == ' ')
	{
			msg += "Please select Consider Due Date in Calendar/Business days !\n";
			flag1 = false;
	}
	...
	if(flag1)
	{
		...
		if(cform_chk == "N"){
			...
			var a = confirm("Do You Want To Submit Data Regarding This SN Bill Clause ???");	
			if(a)
			{
...
<%
	...
	masOthers.setCallFlag("SN_Billing_Dtl");
	masOthers.init();
	...
	System.out.println("due_dt_flag****"+due_dt_flag);
%>  
	...
	<div class="tab-pane active" id="">
		<div class="box mb-0">
			<form method="post" action="../servlet/Frm_Contract_MasterV2">
				...
				<input name="option" type="hidden" value="SN_BillingDetail">
				...
				<input name="TAX_STR_CD" type="hidden" value="">
							...
							<table class="table table-striped" >
								<thead>   
									...
									<tr >
									    ...
									    <td colspan="1"><input type="text" name="period" value="" size="3" style='text-align:right;' onblur="negNumber(this),checkNumber1(this,3,0);">&nbsp;Days</td>
									    <td colspan="3">
											...
											<tr> 
												<td colspan="7" class="info text-center">
													<font color="red" size="1" face="Verdana, Arial, Helvetica, sans-serif">
														FGSA Billing Detail is Shown Here, Please Submit it for Supply Notice.
													</font>
												</td>
											</tr>
										<% } %>
