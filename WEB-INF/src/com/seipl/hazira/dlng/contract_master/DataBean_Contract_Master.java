...
//import com.hazira.hlpl.tlu.cargo_procurement.DataBean_Cargo_Procurement;
...
public class DataBean_Contract_Master
{
	...
	public Vector vsn_plant_inr_mmbtu = new Vector();
	public Vector vsn_plant_inr_km = new Vector();
	public Vector buyer_plant_seq_no = new Vector();
	public Vector vsn_plant_lumpsum_flg = new Vector();
	...
	public String ALLOCATED_QTY = "0"; //Introduced By Samik Shah On 7th August, 2010 ...
	public double allocated_qty = 0;
	...
	public Vector vStartDt = new Vector(); //SB20200402
	public Vector vEndDt = new Vector(); //SB20200402
...
//	 INTRODUCE BY MILAN 31 OCT 2011 MD20111031
	...
	String dcq_mt="0";//Hiren_20200427
	Vector TAX_cform_flg=new Vector();
	String cont_typ="";
	Vector TAX_Plant_cd = new Vector();
	
	public String getDcq_mt() {
		return dcq_mt;
	}

	public String getTcq_mt() {
		return tcq_mt;
	}

	String tcq_mt = "0";//Hiren_20200427
...
//Folling Vector Introduce By Jaimin on 06th Jan 2012 
	...
	String SECURITY_FLAG_SN="";
	String  SECURITY_AMT_SN="";
	String SECURITY_CUR_SN="";
	
	String LUMPSUM_FLAG_SN="";
	String  LUMPSUM_AMT_SN="";
	String LUMPSUM_CUR_SN="";
	...
	String SECURITY_FLAG_LOA="";
	String SECURITY_AMT_LOA="";
	String SECURITY_CUR_LOA="";
	
	String LUMPSUM_FLAG_LOA="";
	String LUMPSUM_AMT_LOA="";
	String LUMPSUM_CUR_LOA="";
...
//	pp20102014
	...
	public String DDA_Dt = "";
	public String getDDA_Dt() {return DDA_Dt;	}
	public String DDA_Dt_Tm = "";
	public String getDDA_Dt_Tm() {return DDA_Dt_Tm;}
	//
	    ...
	    try
	    {
	    	...
	    	if(ds != null) 
	    	{
	    		...
	    		if(conn != null)  
	    		{
	    			...
	    			checkForTable();
	    			addColumns();
	    			if(callFlag.equalsIgnoreCase("FGSA_MST"))
					{
	    				CHECKFORCOLUMN();
	    			...
	    			else if(callFlag.equalsIgnoreCase("FGSA_LIST"))
	    			{
	    				fetchFGSA();
	    			}
	    			...
	    			else if(callFlag.equalsIgnoreCase("BUYER_LIST"))
	    			{
	    				if(Customer_access_flag.equals("Y"))
	    				{
	    			...
	    			else if(callFlag.equalsIgnoreCase("TENDER_MST"))
					{
	    				if(Customer_access_flag.equals("Y"))
	    				{
	    					Customer_DTL_WITH_ACCESS();
					...
					else if(callFlag.equalsIgnoreCase("SN_MST")) //SB20200701
	    			{
						
						if(Customer_access_flag.equals("Y"))
	    				{
	    					Customer_DTL_WITH_ACCESS(); //SB20200701
	    				} else {
	    					SN_Customer_DTL(); //SB20200701
	    				}
						if(!bscode.equalsIgnoreCase("0") && !bscode.equalsIgnoreCase("") ) {
		    				
							fetch_Buyer_details();
		    				fetchAllClausesForSNDefination();  //SB20200701: Used FMS7_CLAUSE_MST
		    				fetchSupplyStation(); //SB20200701
		    				//Data from the SN which are submitted
		    				fetch_SN_details(); //SB20200701
		    				fetcg_SN_transporter_details(); //SB20200701
		    				fetchTruckTransportMst(); //SB20200806
		    				String MappID=bscode+"-"+FGSA_cd+"-"+FGSA_REVNo+"-"+SN_CD+"-"+SN_REVNo; //SB20200809
		    				fetch_CustTrans_details(MappID);//SB20200806
		    				fetch_SN_clauses_details(); //SB20200701: Used FMS7_CLAUSE_MST
		    				fetch_SN_Plant_details(); //SB20200701
		    			
		    				//Data from the FGSA
		    				fetch_governing_clauses();  //SB20200701
		    				fetch_FGSA_Plant_details(); //SB20200701
		    				fetch_FGSA_Transporter_Details_For_SN();  //SB20200701
		    				fetch_FGSA_clauses_details(); //SB20200701: Used FMS7_CLAUSE_MST
		    				fetch_FGSA_advance_clause_details();	//RG20140923
		    				fetch_LC_details("S");
		    				fetch_SN_Billing_Dtl(); //SB20200701
	//	    				fetch_SN_approval_dtl("S");
		    				fetch_SN_approval_dtl2("S");
		    				if(SN_BASE.equals("D")) {
		    					fetch_Sales_Transporter_dtl("S",bscode,FGSA_cd,FGSA_REVNo,SN_CD,SN_REVNo);
		    				}
						}
//	    				System.out.println("**********last*******");
	    			}
					else if(callFlag.equalsIgnoreCase("SN_LIST")) //SB20200701
	    			{
	    			    fetch_SN_List();	 //SB20200701    
	    			 //   fetch_new_fgsa_rev_no();
	    			}
					else if(callFlag.equalsIgnoreCase("SN_LIABILITY_CLAUSE")) //SB20200702 //ADDED BY MANOJ
	    			{
	    				SN_LIABILITY_CLAUSE_DTL();	  //SB20200702   			    
	    			}
	    			else if(callFlag.equalsIgnoreCase("LOA_MST"))  //SB20200704 //ADDED BY MANOJ
	    			{
//	    				System.out.println("Customer_access_flag****"+Customer_access_flag);
	    				...
	    				//	Customer_DTL_WITH_ACCESS();
	    					...
	    					Customer_DTL(); //SB20200704
	    				}
	    				if(!bscode.equalsIgnoreCase("0") && !bscode.equalsIgnoreCase("") ) {
		    				fetch_Buyer_details();
		    				fetchAllClausesForSNDefination(); //SB20200704
		    				fetchSupplyStation(); //SB20200704
		    				//Data from the LOA which are submitted
		    				fetch_LOA_details(); //SB20200704
		    				fetch_LOA_transporter_details(); //SB20200704
		    				fetchTruckTransportMst(); //SB20200806
		    				String MappID=bscode+"-"+tender_cd+"-0-"+LOA_CD+"-"+LOA_REVNo; //SB20200809
		    				fetch_CustTrans_details(MappID);//SB20200806
		    				fetch_LOA_clauses_details(); //SB20200704
		    				fetch_LOA_Plant_details(); //SB20200704
		    				//Data from the TENDER
		    				fetch_tender_governing_clauses(); //SB20200704
		    				fetch_Tender_Plant_details(); //SB20200704
		    				fetch_Tender_Transporter_details(); //SB20200704
		    			    fetch_Tender_clauses_details(); //SB20200704
		    			    fetch_Tender_advance_clause_details();	//SB20200704 //RG20140923
		    			    fetch_LC_details("L"); //SB20200704
		    			    fetch_LOA_Billing_Dtl(); //SB20200704
		    			   //SB20200328 fetch_SN_approval_dtl("L");
		    			    fetch_SN_approval_dtl2("L"); //SB20200704 //SB20200327
	//	    			    System.out.println("LOA_BASE---"+LOA_BASE);
		    			    if(LOA_BASE.equals("D")) {
		    					fetch_Sales_Transporter_dtl("L",bscode,tender_cd,"0",LOA_CD,LOA_REVNo);
		    				}
	    				}
	    			}	  
	    			else if(callFlag.equalsIgnoreCase("LOA_LIST"))//SB20130906 //ADDED BY MANOJ
	    			{
	    			    ...
	    			    fetch_LOA_List2();	 //SB20200704 //SB20130906
	    			}
	    			else if(callFlag.equalsIgnoreCase("LOA_LIABILITY_CLAUSE")) //SB20200704 //ADDED BY MANOJ
	    			{
	    				LOA_LIABILITY_CLAUSE_DTL(); //SB20200704 	   	    
	    			}
	    			///////////////////////^^^^^^^^^^^^^^^/////////////////////////////////
...
//	    				System.out.println("Customer_access_flag"+Customer_access_flag);
	    			...
	    			else if(callFlag.equalsIgnoreCase("SN_DCQ_LIST")) //Introduced By Samik Shah On 13th July, 2010 ...
	    			{
	    				Fetch_SN_DCQ_LIST();
	    			}
	    			...
	    			else if(callFlag.equalsIgnoreCase("Fetch_FGSA_Tender_LC_Dtl"))
	    			{
	    				fetch_LC_Dtl();
//	    				Fetch_FGSA_Tender_LC_Dtl();
	...
	private String trans_cont_st_dt = "";
	private String trans_cont_end_dt = "";
	private String trans_cont_no = "";
	private String trans_trucks_cnt = "";
	private String trans_total_qty = "";
	private String trans_cont_sign_dt = "";
	private String truck_fm = "";
	private String truck_re = "";
	private String qty_fm = "";
	private String qty_re = "";
	private String trans_cont_rad_flg = "";

	private void fetch_Sales_Transporter_dtl(String contract_type,String cust_cd,String fgsa_cd,String fgsa_revno,String sn_cd,String sn_revno)throws SQLException,IOException {
		try {
			
			String selSql = "SELECT to_char(TRANS_CONT_END_DT,'dd/mm/yyyy'),TRANS_CONT_NO,"
					+ "to_char(TRANS_CONT_START_DT,'dd/mm/yyyy'),TRANS_CONT_TOTAL_QTY,TRANS_CONT_TRUCKS,"
					+ " TRUCK_FIRM,TRUCK_RE,QTY_FIRM,QTY_FIRM,BIFURCATION_FLAG,to_char(SIGNING_DT,'dd/mm/yyyy')"
					+ " FROM DLNG_SALES_TRANSPORTER_MST WHERE "
					+ " CUSTOMER_CD = '"+cust_cd+"' "
					+ " AND AGREEMENT_NO = '"+fgsa_cd+"'"
					+ " AND AGREEMENT_REV_NO = '"+fgsa_revno+"'"
					+ " AND CONTRACT_NO = '"+sn_cd+"'"
					+ " AND CONTRACT_REV_NO = '"+sn_revno+"' "
					+ " AND CONTRACT_TYPE = '"+contract_type+"'";
//			System.out.println("selSql----"+selSql);
			rset = stmt.executeQuery(selSql);
			if(rset.next()) {
				
				trans_cont_st_dt = rset.getString(3)==null?"":rset.getString(3);
				trans_cont_end_dt = rset.getString(1)==null?"":rset.getString(1);
				trans_cont_no = rset.getString(2)==null?"":rset.getString(2);
				trans_trucks_cnt = rset.getString(5)==null?"":rset.getString(5);
				trans_total_qty = rset.getString(4)==null?"":rset.getString(4);
				truck_fm = rset.getString(6)==null?"":rset.getString(6);
				truck_re = rset.getString(7)==null?"":rset.getString(7);
				qty_fm = rset.getString(8)==null?"":rset.getString(8);
				qty_re = rset.getString(9)==null?"":rset.getString(9);
				trans_cont_rad_flg= rset.getString(10)==null?"":rset.getString(10);
				trans_cont_sign_dt = rset.getString(11)==null?"":rset.getString(11);
	...
	private void addColumns() throws SQLException  {
		try {
			int count=0;
			String s="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_SN_MST' "+
					" AND UPPER(COLUMN_NAME) LIKE 'CURRENCY_CD'";
//			System.out.println("s****"+s);
			...
			if(count==0)
			{
				s="ALTER TABLE DLNG_SN_MST ADD CURRENCY_CD NUMBER(2,0)";
				stmt.executeUpdate(s);
				conn.commit();
			}
			
			int count1=0;
			String s1="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_LOA_MST' "+
					" AND UPPER(COLUMN_NAME) LIKE 'CURRENCY_CD'";
//			//System.out.println("s****"+s);
			...
			if(count1==0)
			{
				s1="ALTER TABLE DLNG_LOA_MST ADD CURRENCY_CD NUMBER(2,0)";
				stmt.executeUpdate(s1);
				conn.commit();
			}
			
			int count2=0;
			String s2="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_ADVC_PAY_MST' "+
...
//			//System.out.println("s****"+s);
			...
			if(count2==0)
			{
				s2="ALTER TABLE DLNG_ADVC_PAY_MST ADD PAY_TYPE VARCHAR2(2 BYTE)";
				stmt.executeUpdate(s2);
				conn.commit();
			}
			
			int count3=0;
			String s3="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_ADVC_PAY_MST' "+
					" AND UPPER(COLUMN_NAME) LIKE 'APPROVED_BY'";
//			//System.out.println("s****"+s);
			...
			if(count3==0)
			{
				s3="ALTER TABLE DLNG_ADVC_PAY_MST ADD APPROVED_BY NUMBER(6,0)";
				stmt.executeUpdate(s3);
				conn.commit();
			}
			
			int count4=0;
			String s4="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_ADVC_PAY_MST' "+
					" AND UPPER(COLUMN_NAME) LIKE 'APPROVED_DT'";
//			//System.out.println("s****"+s);
			...
			if(count4==0)
			{
				s4="ALTER TABLE DLNG_ADVC_PAY_MST ADD APPROVED_DT DATE";
				stmt.executeUpdate(s4);
				conn.commit();
			}
			int count7=0;
			String s7="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_ADVC_PAY_MST' "+
					" AND UPPER(COLUMN_NAME) LIKE 'APPROVED_FLAG'";
//			//System.out.println("s****"+s);
			...
			if(count7==0)
			{
				s7="ALTER TABLE DLNG_ADVC_PAY_MST ADD APPROVED_FLAG CHAR(1 BYTE)";
				stmt.executeUpdate(s7);
				conn.commit();
			}
			
			int count8=0;
			String s8="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_SN_PLANT_MST' "+
					" AND UPPER(COLUMN_NAME) LIKE 'LUMPSUM_FLAG'";
//			//System.out.println("s****"+s);
			...
			if(count8==0)
			{
				s8="ALTER TABLE DLNG_SN_PLANT_MST ADD LUMPSUM_FLAG CHAR(1 BYTE)";
				stmt.executeUpdate(s8);
				conn.commit();
			}
			
			count8=0;
			s8="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_LOA_PLANT_MST' "+
					" AND UPPER(COLUMN_NAME) LIKE 'LUMPSUM_FLAG'";
//			//System.out.println("s****"+s);
			rset=stmt.executeQuery(s8);
			if(rset.next())
			...
			if(count8==0)
			{
				s8="ALTER TABLE DLNG_LOA_PLANT_MST ADD LUMPSUM_FLAG CHAR(1 BYTE)";
				stmt.executeUpdate(s8);
				conn.commit();
			}
			
			count8=0;
			s8="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_SALES_TRANSPORTER_MST' AND UPPER(COLUMN_NAME) LIKE 'TRUCK_FIRM'";
//			//System.out.println("s****"+s);
			rset=stmt.executeQuery(s8);
			if(rset.next())
			{
			...
			if(count8==0)
			{
				s8="ALTER TABLE DLNG_SALES_TRANSPORTER_MST"
						+ " ADD (TRUCK_FIRM NUMERIC(11,6),"
						+ " TRUCK_RE NUMERIC(11,6),"
						+ " QTY_FIRM NUMERIC(11,6),"
						+ " QTY_RE NUMERIC(11,6),"
						+ " BIFURCATION_FLAG CHAR(1 BYTE),"
						+ " SIGNING_DT DATE)";
				stmt.executeUpdate(s8);
				conn.commit();
			}
			
			//FOLLOWING CODE DONE BY HARSH 20211028 ADDIND THREE NEW COLUMN IN DLNG_SN_MST & DLNG_LOA_MST
			count8=0;
			s8="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_SN_MST' "+
					" AND UPPER(COLUMN_NAME) LIKE 'DEAL_ENT_DT'";
//			//System.out.println("s****"+s);
			rset=stmt.executeQuery(s8);
			if(rset.next())
			{
			...
			if(count8==0)
			{
				s8="ALTER TABLE DLNG_SN_MST ADD DEAL_ENT_DT DATE";
				stmt.executeUpdate(s8);
				conn.commit();
			}
			...
			count8=0;
			s8="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_SN_MST' "+
					" AND UPPER(COLUMN_NAME) LIKE 'SIGNING_TIME'";
//			//System.out.println("s****"+s);
			rset=stmt.executeQuery(s8);
			if(rset.next())
			{
			...
			if(count8==0)
			{
				s8="ALTER TABLE DLNG_SN_MST ADD SIGNING_TIME VARCHAR2(6 BYTE)";
				stmt.executeUpdate(s8);
				conn.commit();
			}
			
			count8=0;
			s8="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_LOA_MST' "+
					" AND UPPER(COLUMN_NAME) LIKE 'DEAL_ENT_DT'";
//			//System.out.println("s****"+s);
			rset=stmt.executeQuery(s8);
			if(rset.next())
			...
			if(count8==0)
			{
				s8="ALTER TABLE DLNG_LOA_MST ADD DEAL_ENT_DT DATE";
				stmt.executeUpdate(s8);
				conn.commit();
			}
...
//			//System.out.println("s****"+s);
			...
			if(count8==0)
			{
				s8="ALTER TABLE DLNG_LOA_MST ADD SIGNING_TIME VARCHAR2(6 BYTE)";
				stmt.executeUpdate(s8);
				conn.commit();
			}
			...
			count8=0;
			s8="SELECT COUNT(COLUMN_NAME) FROM COLS WHERE UPPER(TABLE_NAME) LIKE 'DLNG_LOA_MST' "+
					" AND UPPER(COLUMN_NAME) LIKE 'DEAL_ENT_BY'";
//			//System.out.println("s****"+s);
			rset=stmt.executeQuery(s8);
			if(rset.next())
			{
			...
			if(count8==0)
			{
				s8="ALTER TABLE DLNG_LOA_MST ADD DEAL_ENT_BY NUMBER(6)";
				stmt.executeUpdate(s8);
				conn.commit();
			}
...
//			//System.out.println("s****"+s);
			...
			if(count8==0)
			{
				s8="ALTER TABLE DLNG_SN_MST ADD DEAL_ENT_BY NUMBER(6)";
				stmt.executeUpdate(s8);
				conn.commit();
			}
...
//			System.out.println("fetch_LC_Dtl***1*"+queryString);
	...
	public void fetch_SN_approval_dtl(String cont_type) throws Exception {
		try {
			if(cont_type.equals("S")) {
				queryString = "SELECT NVL(FLAG,'') FROM DLNG_CARGO_ALLOC_REVISED_DTL WHERE FGSA_NO='"+FGSA_cd+"' "
						+ "AND SN_NO='"+SN_CD+"' AND CUSTOMER_CD='"+bscode+"' AND CONTRACT_TYPE='"+cont_type+"' "
						+ "ORDER BY ENT_DT DESC";
			} else if(cont_type.equals("L")) {
				queryString = "SELECT NVL(FLAG,'') FROM DLNG_CARGO_ALLOC_REVISED_DTL WHERE FGSA_NO='"+tender_cd+"' "
						+ "AND SN_NO='"+LOA_CD+"' AND CUSTOMER_CD='"+bscode+"' AND CONTRACT_TYPE='"+cont_type+"' "
						+ "ORDER BY ENT_DT DESC";
			}
//			System.out.println("Fetching Fla..."+queryString);
			rset = stmt.executeQuery(queryString);
			if(rset.next()) {
	...
	public void checkForTable() throws Exception {
		try {
			int count = 0;
			String query="SELECT COUNT(TNAME) FROM TAB WHERE UPPER(TNAME)='DLNG_CARGO_ALLOC_REVISED_DTL'";
			...
			if(rset.next())
			{
				...
				if(count==0)
				{
					query="CREATE TABLE DLNG_CARGO_ALLOC_REVISED_DTL ("
							+ "FGSA_NO NUMBER(6,0),"
				...
				while(rset.next()) {
					...
					if(rset1.next()) {
						...
						if(count==0) {
							...
							int countData = 0;
							queryString = "SELECT CARGO_REF_NO,MARGIN,TOTAL_MARGIN,AVG_MARGIN,SALE_PRICE,ALLOC_QTY FROM "
...
//								System.out.println("Fetching Data...."+queryString);
							...
							if(countData>0) {
								...
								queryString = "SELECT NVL(MODIFICATION_SEQ_NO,'0'),NVL(FLAG,''),ENT_BY,APPROVE_BY,"
										+ "NEW_SALE_PRICE,NEW_MARGIN,NEW_AVG_MARGIN,NEW_TOT_MARGIN FROM DLNG_CARGO_ALLOC_REVISED_DTL WHERE "
								...
								if(rset2.next()) {
									...
									for(int k=0;k<temp_ref_no.size();k++) {
										queryString = "SELECT NEW_SALE_PRICE,NEW_MARGIN,NEW_AVG_MARGIN,NEW_TOT_MARGIN "
												+ "FROM DLNG_CARGO_ALLOC_REVISED_DTL WHERE "
				...
				queryString = "SELECT TENDER_NO,TENDER_NO,LOA_NO,LOA_REV_NO,TO_CHAR(SIGNING_DT,'DD/MM/YYYY'),"
						+ "TO_CHAR(START_DT,'DD/MM/YYYY'),TO_CHAR(END_DT,'DD/MM/YYYY'),TCQ,RATE FROM "
						+ "DLNG_LOA_MST WHERE CUSTOMER_CD='"+customer_cd_+"' ";
//				System.out.println("Fetching Data.."+queryString);
				rset = stmt.executeQuery(queryString);
				while(rset.next()) {
					queryString = "SELECT COUNT(GAS_DT) FROM FMS7_DAILY_BUYER_NOM_DTL WHERE CONTRACT_TYPE='"+contract_type+"' "
...
//			System.out.println("Fetching Mast..."+queryString);	      
	...
	public void FetchContractForAdvance()
	{
		try
		{
			...
			query="SELECT TENDER_NO,TENDER_NO,LOA_NO,LOA_REV_NO,CUSTOMER_CD,"
					+ "TO_CHAR(SIGNING_DT,'DD/MM/YYYY'),TO_CHAR(START_DT,'DD/MM/YYYY'), "
					+ "TO_CHAR(END_DT,'DD/MM/YYYY'), DCQ, TCQ FROM DLNG_LOA_MST A WHERE "
					+ "ADVANCE_COLLECTION_FLAG='Y' AND LOA_REV_NO = (SELECT MAX(B.LOA_REV_NO) "
					+ "FROM DLNG_LOA_MST B WHERE B.LOA_NO=A.LOA_NO AND B.TENDER_NO=A.TENDER_NO AND "
					+ "A.CUSTOMER_CD=B.CUSTOMER_CD AND A.FLAG=B.FLAG) AND A.FLAG='T' AND "
					+ "CUSTOMER_CD='"+customer_cd_advance+"' ";
			rset = stmt.executeQuery(query);
			while(rset.next())
	...
	public void AdvanceCollection()
	{
		try
		{
			...
			/*LOA...*/
			q="SELECT DISTINCT A.CUSTOMER_CD,CUSTOMER_NAME FROM DLNG_LOA_MST A, FMS7_CUSTOMER_MST B "
					+ "WHERE A.CUSTOMER_CD=B.CUSTOMER_CD AND "
					+ "ADVANCE_COLLECTION_FLAG='Y' AND LOA_REV_NO = (SELECT MAX(B.LOA_REV_NO) "
					+ "FROM DLNG_LOA_MST B WHERE B.LOA_NO=A.LOA_NO AND B.TENDER_NO=A.TENDER_NO AND "
					+ "A.CUSTOMER_CD=B.CUSTOMER_CD AND A.FLAG=B.FLAG) AND A.FLAG='T' "
	...
	public void fetch_Tender_advance_clause_details()
	{
		try
		{
			queryString="SELECT ADJUST_FLAG FROM DLNG_TENDER_MST WHERE " +
		...
		//	System.out.println("Fetching ...adjust Flag..."+queryString);
			...
			String mapping_id=""+bscode+"-"+tender_cd+"-%-"+LOA_CD+"-%-"+"L";
...
//				System.out.println("Fetching flag of sn..."+queryString);
				...
				if(rset.next())
				{
					...
					{
						queryString1 = "select price_rate,currency_cd,flag " +
								"FROM DLNG_CONT_PRICE_DTL WHERE mapping_id like '"+mapping_id+"' AND " +
								"price_cd='"+component_cd.elementAt(i)+"' AND FLAG='Y' and PAY_TYPE = 'AP' ";
//						System.out.println("Fetching flag of LoA..."+queryString1);
						rset1=stmt1.executeQuery(queryString1);
						if(rset1.next()) {
							
							ADJUST_FLAG_LOA=rset1.getString(3)==null?"N":rset1.getString(3);
							ADJUST_AMT_LOA=rset1.getString(1)==null?"":rset1.getString(1);
							ADJUST_CUR_LOA=rset1.getString(2);
						}
						
						queryString1 = "select price_rate,currency_cd,flag " +
								"FROM DLNG_CONT_PRICE_DTL WHERE mapping_id like '"+mapping_id+"' AND " +
								"price_cd='"+component_cd.elementAt(i)+"' AND FLAG='Y' and PAY_TYPE = 'SP' ";
//						System.out.println("Fetching flag of LoA..."+queryString1);
						rset1=stmt1.executeQuery(queryString1);
						if(rset1.next()) {
							
							SECURITY_FLAG_LOA=rset1.getString(3)==null?"N":rset1.getString(3);
							SECURITY_AMT_LOA=rset1.getString(1)==null?"":rset1.getString(1);
							SECURITY_CUR_LOA=rset1.getString(2);
						}
						
						queryString1 = "select price_rate,currency_cd,flag " +
								"FROM DLNG_CONT_PRICE_DTL WHERE mapping_id like '"+mapping_id+"' AND " +
								"price_cd='"+component_cd.elementAt(i)+"' AND FLAG='Y' and PAY_TYPE = 'LP' ";
//						System.out.println("Fetching flag of LoA..."+queryString1);
						rset1=stmt1.executeQuery(queryString1);
						if(rset1.next()) {
							
							LUMPSUM_FLAG_LOA=rset1.getString(3)==null?"N":rset1.getString(3);
							LUMPSUM_AMT_LOA=rset1.getString(1)==null?"":rset1.getString(1);
							LUMPSUM_CUR_LOA=rset1.getString(2);
						}
...
//			System.out.println("Fetching..component dtls..."+queryString);
			...
			String mapping_id=""+bscode+"-"+FGSA_cd+"-%-"+SN_CD+"-%-S";
			for(int i=0;i<component_cd.size();i++)
			{
				queryString = "select price_rate,currency_cd,flag " +
						"FROM DLNG_CONT_PRICE_DTL WHERE mapping_id like '"+mapping_id+"' AND " +
				...
				if(rset.next())
				{
					if(component_cd.elementAt(i).equals("1"))
					{
						queryString1 = "select price_rate,currency_cd,flag " +
								"FROM DLNG_CONT_PRICE_DTL WHERE mapping_id like '"+mapping_id+"' AND " +
								"price_cd='"+component_cd.elementAt(i)+"' AND FLAG='Y' and PAY_TYPE='AP' ";
//						System.out.println("Fetching flag of sn PAY_TYPE..."+queryString1);
						rset1=stmt1.executeQuery(queryString1);
						if(rset1.next())
						{
							ADJUST_FLAG_SN=rset1.getString(3)==null?"N":rset1.getString(3);
							ADJUST_AMT_SN=rset1.getString(1)==null?"":rset1.getString(1);
							ADJUST_CUR_SN=rset1.getString(2);
						}
...
//						System.out.println("Fetching flag of sn PAY_TYPE..."+queryString1);
						...
						if(rset1.next())
						{
							SECURITY_FLAG_SN=rset1.getString(3)==null?"N":rset1.getString(3);
							SECURITY_AMT_SN=rset1.getString(1)==null?"":rset1.getString(1);
							SECURITY_CUR_SN=rset1.getString(2);
						}
...
//						System.out.println("Fetching flag of sn PAY_TYPE..."+queryString1);
						...
						if(rset1.next())
						{
							LUMPSUM_FLAG_SN=rset1.getString(3)==null?"N":rset1.getString(3);
							LUMPSUM_AMT_SN=rset1.getString(1)==null?"":rset1.getString(1);
							LUMPSUM_CUR_SN=rset1.getString(2);
						}
					}
					else if(component_cd.elementAt(i).equals("2"))
					{
	...
	public void Fetch_RE_GAS_CARGO_DTL_CLOSURE()
	{
		try
		{
			...
			for(int i=0; i<Integer.parseInt(no_of_cargo); i++)
			{
				...
				queryString1 = "SELECT SUM(EXIT_TOT_ENE) FROM DLNG_ALLOC_MST WHERE "
						+ " PARTY_CD="+Buyer_cd+""
						+ " AND MAPPING_ID LIKE '"+Buyer_cd+"-"+re_gas_no+"-0-"+(i+1)+"-%'"
						+ " AND CONTRACT_TYPE='R'";	
				//System.out.println("SELECT SUM(QTY_MMBTU) FROM DLNG_DAILY_ALLOCATION_DTL --->"+queryString1);
				rset1 = stmt1.executeQuery(queryString1);
				if(rset1.next())
				{
	...
	public void fetch_LOA_Closure_List()
	{
		try 
		{
			if(bscode!=null && !bscode.trim().equals("") && !bscode.trim().equals("0"))
			{
				...
				"FROM DLNG_LOA_MST A, FMS7_CUSTOMER_MST C,FMS7_UNIT_MST D WHERE " +
				"A.FLAG='T' AND A.LOA_REV_NO=(SELECT MAX(B.LOA_REV_NO) FROM " +
				"DLNG_LOA_MST B WHERE A.LOA_NO=B.LOA_NO AND A.TENDER_NO=B.TENDER_NO " +
			...
			else
			{
				if(Customer_access_flag.equals("Y"))
				{
					queryString = "SELECT A.LOA_NO, A.LOA_REV_NO, A.CUSTOMER_CD, A.TENDER_NO," +
							"A.TCQ, D.UNIT_ABR,A.RATE,A.RATE_UNIT,C.CUSTOMER_NAME, C.CUSTOMER_ABBR, A.LOA_NAME, " +
							"A.VERIFY_FLAG, A.APPROVE_FLAG, A.LOA_REF_NO,A.TCQ_REQUEST_SIGN,A.TCQ_REQUEST_QTY " +
							"FROM DLNG_LOA_MST A,FMS7_CUSTOMER_MST C,FMS7_UNIT_MST D, SEC_EMP_CUSTOMER_ALLOC_MST E "
							+ "WHERE " +
							"A.FLAG='T' AND A.LOA_REV_NO=(SELECT MAX(B.LOA_REV_NO) FROM " +
							"DLNG_LOA_MST B WHERE A.LOA_NO=B.LOA_NO AND A.TENDER_NO=B.TENDER_NO " +
	...
	public void Customer_DTL_WITH_ACCESS()
	{
		try
		{
			queryString = "SELECT A.CUSTOMER_CD,CUSTOMER_NAME,CUSTOMER_ABBR "
				...
				//SB20200701:NR	+ " AND CUSTOMER_CD IN (SELECT CUSTOMER_CD FROM FMS7_SN_MST WHERE END_DT >=SYSDATE ) " //SB20200402
...
//			System.out.println("FMS7_CUSTOMER_MST Fetch Query = "+queryString);
			...
			while(rset.next())
			{
				...
				//SB20200402	CUST_NM.add(rset.getString(3)==null?"":rset.getString(3));
	...
	public void SN_Customer_DTL()
	{
		try
		{
			queryString = "SELECT CUSTOMER_CD,CUSTOMER_NAME,CUSTOMER_ABBR FROM FMS7_CUSTOMER_MST A "
					...
					//SB20200701		+ " AND CUSTOMER_CD IN (SELECT CUSTOMER_CD FROM DLNG_SN_MST WHERE END_DT >=SYSDATE ) " //SB20200402
					+ " AND CUSTOMER_CD IN (SELECT CUSTOMER_CD FROM DLNG_FLSA_MST WHERE END_DT >=SYSDATE AND FLAG='Y')"
					+ " AND EFF_DT=(SELECT MAX(EFF_DT) FROM FMS7_CUSTOMER_MST C WHERE A.CUSTOMER_CD=C.CUSTOMER_CD AND C.EFF_DT<=SYSDATE) "
					+ "ORDER BY CUSTOMER_NAME";
			System.out.println("FMS7_CUSTOMER_MST Fetch Query 2= "+queryString);
			rset = stmt.executeQuery(queryString);				
			while(rset.next())
			{
				CUST_CD.add(rset.getString(1)==null?"":rset.getString(1));	
...
//					JHP start
					...
					queryString = "select count(*) FROM DLNG_INVOICE_MST WHERE customer_cd='"+Buyer_cd+"' and  to_date('"+temp_dt+"','dd/mm/yyyy') between period_start_dt and period_start_dt";
			//		System.out.println("REGAS:QRY-R2004:SELECT:DLNG_INVOICE_MST: "+queryString);
					rset = stmt.executeQuery(queryString);
					if(rset.next())
					{
	...
	public void Fetch_SN_DCQ_LIST()
	{
		try
		{
			queryString = "SELECT TO_CHAR(FROM_DT,'DD/MM/YYYY'), TO_CHAR(TO_DT,'DD/MM/YYYY'), DCQ, REMARK " +
						  ...
						  "FGSA_REV_NO="+FGSA_REVNo+" AND SN_NO="+SN_CD+" AND SN_REV_NO="+SN_REVNo+"";
			rset = stmt.executeQuery(queryString);			
			while(rset.next())
			{
	...
	public void Fetch_FGSA_DEACTIVATION_LIST()
	{
		try
		{
			queryString = "SELECT TO_CHAR(FROM_DT,'DD/MM/YYYY'), TO_CHAR(TO_DT,'DD/MM/YYYY'), REMARK " +
						  ...
						  "WHERE CUSTOMER_CD="+Buyer_cd+" And FGSA_NO="+FGSA_cd+" AND " +
						  "FGSA_REV_NO="+FGSA_REVNo+" ORDER BY FROM_DT";
			rset = stmt.executeQuery(queryString);		
			while(rset.next())
			{
...
//			System.out.println("queryString---"+queryString);
			...
			while(rset.next())
			{
				...
				TAX_Plant_cd.add(rset.getString(1)==null?"":rset.getString(1));
				...
				if(cont_typ.equals("L")){
					...
					agr_rev_no=FGSA_REVNo;
				}
				
				queryString="SELECT CFORM_FLAG FROM FMS7_CFORM_CONTRACT_DTL WHERE AGR_NO='"+FGSA_cd+"' And AGR_REV_NO='"+agr_rev_no+"' And "
						+ "CUSTOMER_CD='"+bscode+"' And CONTRACT_TYPE='"+cont_typ+"' And CONTRACT_NO='"+SN_CD+"' And CONTRACT_REV_NO='"+SN_REVNo+"'"
						+ " and plant_seq_no='"+rset.getString(1)+"' AND COMMODITY_TYPE='DLNG'";
//				System.out.println("nbn---"+queryString);
				rset1=stmt1.executeQuery(queryString);
				if(rset1.next()){
					TAX_cform_flg.add(rset1.getString(1)==null?"":rset1.getString(1));
				}else{
					TAX_cform_flg.add("");
				}
			}
	...
	public void SN_LIABILITY_CLAUSE_DTL()
	{
		...
		try
		{
			queryString = "select CUSTOMER_CD,FLSA_NO,FLSA_REV_NO,CONT_TYPE,SN_NO,SN_REV_NO,PRICE_PER,PRICE,PROMISE_QTY_FREQ,LIABILITY_PER,DCQ_FLAG,PNDCQ_FLAG ,MDCQ_FLAG,REMARKS,TO_CHAR(LD_FROM_DT,'dd/mm/yyyy'),TO_CHAR(LD_TO_DT,'dd/mm/yyyy') "
					+ "from DLNG_SN_LD_DTL WHERE FLSA_NO='"+FGSA_cd+"' And FLSA_REV_NO='"+FGSA_REVNo+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='S' And SN_NO='"+SN_CD+"' And SN_REV_NO='"+SN_REVNo+"'";
			rset = stmt.executeQuery(queryString);		
			while(rset.next())
			{
			...
			if(flag)
			{
				queryString = "select * from DLNG_FLSA_LD_DTL WHERE FLSA_NO='"+FGSA_cd+"' And FLSA_REV_NO='"+FGSA_REVNo+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='F'";
				rset = stmt.executeQuery(queryString);			
				while(rset.next())
				{				
		...
		try
		{		
			queryString = "select CUSTOMER_CD,FLSA_NO,FLSA_REV_NO,CONT_TYPE,SN_NO,SN_REV_NO,PRICE_PER,PRICE,TOP_PER,ACTUAL_OBLIG_QTY,PROMISE_QTY_FREQ,REMARKS,TO_CHAR(TOP_FROM_DT,'dd/mm/yyyy'),TO_CHAR(TOP_TO_DT,'dd/mm/yyyy') "
					+ "from DLNG_SN_TOP_DTL WHERE FLSA_NO='"+FGSA_cd+"' And FLSA_REV_NO='"+FGSA_REVNo+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='S' And SN_NO='"+SN_CD+"' And SN_REV_NO='"+SN_REVNo+"'";
			rset = stmt.executeQuery(queryString);		
			while(rset.next())
			{		
			...
			if(flag)
			{
				queryString = "select * from DLNG_FLSA_TOP_DTL WHERE FLSA_NO='"+FGSA_cd+"' And FLSA_REV_NO='"+FGSA_REVNo+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='F'";
				rset = stmt.executeQuery(queryString);			
				while(rset.next())
				{			
		...
		try
		{			
			queryString = "select * from DLNG_SN_MAKEUPGAS_DTL WHERE FLSA_NO='"+FGSA_cd+"' And FLSA_REV_NO='"+FGSA_REVNo+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='S' And SN_NO='"+SN_CD+"' And SN_REV_NO='"+SN_REVNo+"'";
			rset = stmt.executeQuery(queryString);			
			while(rset.next())
			{			
			...
			if(flag)
			{
				queryString = "select * from DLNG_FLSA_MAKEUPGAS_DTL WHERE FLSA_NO='"+FGSA_cd+"' And FLSA_REV_NO='"+FGSA_REVNo+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='F'";
				rset = stmt.executeQuery(queryString);				
				while(rset.next())
				{				
		...
		{
			 price1 =nf2.format(Double.parseDouble(price_per1)*Double.parseDouble(RATE)/100);			 
		}
		else
		{
			 price1 ="0";		
		...
		{			 
			price2 =nf2.format(Double.parseDouble(price_per2)*Double.parseDouble(RATE)/100);			
		}
		else
		{			
			 price2 ="0";
		...
		{			 
			price3 =nf2.format(Double.parseDouble(price_per3)*Double.parseDouble(RATE)/100);
		}
		else
		{			
			 price3 ="0";
	...
	public void LOA_LIABILITY_CLAUSE_DTL()
	{
		...
		try
		{			
			queryString = "select CUSTOMER_CD,FLSA_NO,FLSA_REV_NO,CONT_TYPE,LOA_NO,LOA_REV_NO, PRICE_PER,PRICE,PROMISE_QTY_FREQ,LIABILITY_PER,DCQ_FLAG,PNDCQ_FLAG,MDCQ_FLAG,REMARKS,TO_CHAR(LD_FROM_DT,'dd/mm/yyyy'),TO_CHAR(LD_TO_DT,'dd/mm/yyyy') "
					+ "from DLNG_LOA_LD_DTL WHERE FLSA_NO='"+FGSA_cd+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='L' And LOA_NO='"+SN_CD+"' And LOA_REV_NO='"+SN_REVNo+"'";
			rset = stmt.executeQuery(queryString);		
			while(rset.next())
			{		
				price_per1=rset.getString(7)==null?"":rset.getString(7);
		...
		try
		{		
			queryString = "select CUSTOMER_CD,FLSA_NO,FLSA_REV_NO,CONT_TYPE,LOA_NO,LOA_REV_NO,PRICE_PER,PRICE,TOP_PER,ACTUAL_OBLIG_QTY,PROMISE_QTY_FREQ,REMARKS,TO_CHAR(TOP_FROM_DT,'dd/mm/yyyy'),TO_CHAR(TOP_TO_DT,'dd/mm/yyyy') "
					+ "from DLNG_LOA_TOP_DTL WHERE FLSA_NO='"+FGSA_cd+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='L' And LOA_NO='"+SN_CD+"' And LOA_REV_NO='"+SN_REVNo+"'";
			rset = stmt.executeQuery(queryString);		
			while(rset.next())
			{		
				price_per2=rset.getString(7)==null?"":rset.getString(7);
			...
			if(flag)
			{
				queryString = "select CUSTOMER_CD,TENDER_NO,CONT_TYPE,PRICE_PER,PRICE,TOP_PER,ACTUAL_OBLIG_QTY,PROMISE_QTY_FREQ,REMARKS from "
						+ "DLNG_TENDER_TOP_DTL WHERE TENDER_NO='"+FGSA_cd+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='T' ";
				rset = stmt.executeQuery(queryString);		
				while(rset.next())
				{
		...
		try
		{			
			queryString = "select * from DLNG_LOA_MAKEUPGAS_DTL WHERE FLSA_NO='"+FGSA_cd+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='L' And LOA_NO='"+SN_CD+"' And LOA_REV_NO='"+SN_REVNo+"'";
			rset = stmt.executeQuery(queryString);			
			while(rset.next())
			{		
				makeup_period_per=rset.getString(7)==null?"":rset.getString(7);
	...
	public void fetch_Tender_Billing_Dtl()
	{
		try
		{
			queryString = "select * from FMS7_FGSA_BILLING_DTL WHERE FGSA_NO='"+FGSA_cd+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='T'";
...
boolean billFlag = false;
	public void fetch_SN_Billing_Dtl()
	{
		...
		{
			boolean flag=true;
			queryString = "select * from DLNG_SN_BILLING_DTL "
					+ " WHERE FLSA_NO='"+FGSA_cd+"'"
					+ " And FLSA_REV_NO='"+FGSA_REVNo+"'"
					+ " And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='S' And SN_NO='"+SN_CD+"' And SN_REV_NO='"+SN_REVNo+"'";
			System.out.println("DLNG_SN_BILLING_DTL : "+queryString);
			rset = stmt.executeQuery(queryString);			
			while(rset.next())
			{
				...
				due_dt_flag=rset.getString("DUE_DT_FLAG")==null?"":rset.getString("DUE_DT_FLAG");
				flag=false;
				billFlag = true;
			}
...
//				System.out.println("DLNG_FLSA_BILLING_DTL : "+queryString);
				rset = stmt.executeQuery(queryString);				
				while(rset.next())
				{
					Freq=rset.getString(5)==null?"":rset.getString(5);
	...
	public void fetch_LOA_Billing_Dtl()
	{
		try
		{
			boolean flag=true;
			//System.out.println("bscode == "+bscode);
			queryString = "select CUSTOMER_CD,FLSA_NO,FLSA_REV_NO,SN_NO,SN_REV_NO,CONT_TYPE,BILLING_FREQ,DUE_DATE," +
					"INT_CAL_RATE_CD,INT_CAL_SIGN,INT_CAL_PERCENTAGE,EXCHNG_RATE_CD,EXCHNG_RATE_CAL,INVOICE_CUR_CD," +
					"PAYMENT_CUR_CD,TAX_STRUCT_CD,EXCHG_RATE_NOTE,INV_CRITERIA, FLAG,DUE_DT_FLAG from DLNG_SN_BILLING_DTL " +
					"WHERE FLSA_NO='"+FGSA_cd+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='L' And " +
					"SN_NO='"+SN_CD+"' And SN_REV_NO='"+SN_REVNo+"'";	
			if(pageFlag.equals("Y")) {
				queryString = "select CUSTOMER_CD,FLSA_NO,FLSA_REV_NO,SN_NO,SN_REV_NO,CONT_TYPE,BILLING_FREQ,DUE_DATE," +
						"INT_CAL_RATE_CD,INT_CAL_SIGN,INT_CAL_PERCENTAGE,EXCHNG_RATE_CD,EXCHNG_RATE_CAL,INVOICE_CUR_CD," +
						"PAYMENT_CUR_CD,TAX_STRUCT_CD,EXCHG_RATE_NOTE,INV_CRITERIA, FLAG,DUE_DT_FLAG from DLNG_SN_BILLING_DTL " +
						"WHERE FLSA_NO='"+tender_cd+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='L' And " +
						"SN_NO='"+LOA_CD+"' And SN_REV_NO='"+LOA_REVNo+"'";
			}
//			System.out.println("FMS7_LOA_BILLING_DTL queryStringy = "+queryString);
			rset = stmt.executeQuery(queryString);
			if(rset.next())
			{
				Freq=rset.getString(7)==null?"":rset.getString(7);
...
//			System.out.println("Tax_Struct_Cd = "+billFlag);
			if(flag)
			{
				queryString = "select CUSTOMER_CD,FLSA_NO,FLSA_REV_NO,CONT_TYPE,BILLING_FREQ,DUE_DATE,INT_CAL_RATE_CD," +
				...
				//SB20111207		"TAX_STRUCT_CD,EXCHG_RATE_NOTE,INV_CRITERIA " +
						...
						"from DLNG_FLSA_BILLING_DTL WHERE FLSA_NO='"+FGSA_cd+"' And CUSTOMER_CD='"+bscode+"' And CONT_TYPE='T'";
	...
	public void fetch_SN_approval_dtl2(String cont_type) throws Exception {
		try { 
			...
			if(cont_type.equals("S")) 
			{
				queryString = "SELECT TO_CHAR(START_DT,'DD/MM/YYYY') FROM DLNG_SN_MST WHERE FLSA_NO='"+FGSA_cd+"' "
...
//				System.out.println("QRY-SN000: FMS7_SN_MST: "+queryString);
				...
				queryString = "SELECT DISTINCT FLAG, NEW_SALE_PRICE, TO_CHAR(NEW_PRICE_EFF_DT,'DD/MM/YYYY'), ORI_SALE_PRICE FROM DLNG_CARGO_ALLOC_REVISED_DTL WHERE FLSA_NO='"+FGSA_cd+"' "
			...
			{
				queryString = "SELECT TO_CHAR(START_DT,'DD/MM/YYYY') FROM DLNG_LOA_MST WHERE TENDER_NO='"+tender_cd+"' "
						+ "AND LOA_NO='"+LOA_CD+"' AND CUSTOMER_CD='"+bscode+"'";
//				System.out.println("QRY-SN000: DLNG_LOA_MST: "+queryString);
				rset = stmt.executeQuery(queryString);
				if(rset.next()) {
					start_dt = rset.getString(1)==null?"N.A.":rset.getString(1);
				}
				queryString = "SELECT  FLAG, NEW_SALE_PRICE, TO_CHAR(NEW_PRICE_EFF_DT,'DD/MM/YYYY'), ORI_SALE_PRICE FROM DLNG_CARGO_ALLOC_REVISED_DTL WHERE FLSA_NO='"+tender_cd+"' "
...
//			System.out.println("QRY-SN001: DLNG_CARGO_ALLOC_REVISED_DTL: "+queryString);
			rset = stmt.executeQuery(queryString);
			while(rset.next()) {
			...
			if(cont_type.equals("S")) 
			{
				queryString = "SELECT TO_CHAR(MAX(TO_DATE(NEW_PRICE_EFF_DT,'DD/MM/YYYY')),'DD/MM/YYYY') FROM DLNG_CARGO_ALLOC_REVISED_DTL WHERE FLSA_NO='"+FGSA_cd+"' "
...
//				System.out.println("QRY-SN001: DLNG_CARGO_ALLOC_REVISED_DTL: "+queryString);
			...
			{
				queryString = "SELECT TO_CHAR(MAX(TO_DATE(NEW_PRICE_EFF_DT,'DD/MM/YYYY')),'DD/MM/YYYY') FROM DLNG_CARGO_ALLOC_REVISED_DTL WHERE FLSA_NO='"+tender_cd+"' "
...
//			System.out.println("VNewPrice----"+VNewPrice);
		///////////////////////////////////////////////////////////////////////////
		} catch(Exception e) {
			e.printStackTrace();
		}
	...
	public void fetch_SN_clauses_details()
	{
		try
		{
			queryString = "select A.CLAUSE_CD, B.CLAUSE_NM, B.CLAUSE_ABBR FROM DLNG_SN_CLAUSE_MST A, FMS7_CLAUSE_MST B " +
					"WHERE A.CLAUSE_CD=B.CLAUSE_CD AND A.FLSA_NO='"+FGSA_cd+"' AND A.FLSA_REV_NO='"+FGSA_REVNo+"' AND " +
					"A.BUYER_CD='"+bscode+"' AND B.MST_CLAUSE_CD='0' AND A.SN_NO='"+SN_CD+"' AND A.SN_REV_NO='"+SN_REVNo+"'";
//			System.out.println("fetch_SN_clauses_details***"+queryString);
			rset = stmt.executeQuery(queryString);
			while(rset.next())
			{
	...
	public void fetch_LOA_clauses_details()
	{
		try
		{			  
			queryString = "select A.CLAUSE_CD, B.CLAUSE_NM, B.CLAUSE_ABBR FROM DLNG_LOA_CLAUSE_MST A, FMS7_CLAUSE_MST B" +
...
//			System.out.println("FMS7_LOA_CLAUSE_MST :"+queryString);
	...
	public void fetch_FGSA_clauses_details()
	{
		try
		{
			queryString = "select A.CLAUSE_CD, B.CLAUSE_NM, B.CLAUSE_ABBR FROM DLNG_FLSA_CLAUSE_MST A, FMS7_CLAUSE_MST B " +
					"WHERE A.CLAUSE_CD=B.CLAUSE_CD AND A.FLSA_NO='"+FGSA_cd+"' AND " +
...
//			System.out.println("FMS7_FGSA_CLAUSE_MST :"+queryString);
	...
	public void fetch_Tender_clauses_details()
	{
		try
		{			  
			  queryString = "select A.CLAUSE_CD, B.CLAUSE_NM, B.CLAUSE_ABBR FROM DLNG_TENDER_CLAUSE_MST A," +
	...
	public void fetch_governing_clauses()
	{
		try
		{
			queryString= "Select TO_CHAR(SIGNING_DT,'DD/MM/YYYY'), TO_CHAR(START_DT,'DD/MM/YYYY'), " +
					"TO_CHAR(END_DT,'DD/MM/YYYY'), TO_CHAR(RENEWAL_DT,'DD/MM/YYYY'), FLSA_BASE, " +
					"FLSA_TYPE, STATUS, BUYER_NOM, BUYER_MONTH_NOM, BUYER_WEEK_NOM, " +
					...
					"SPEC_GAS_MIN_ENERGY, SPEC_GAS_MAX_ENERGY from DLNG_FLSA_MST WHERE " +
					"FLSA_NO='"+FGSA_cd+"' AND REV_NO='"+FGSA_REVNo+"' AND CUSTOMER_CD='"+bscode+"'";			
	...
	public void fetch_tender_governing_clauses()
	{
		try
		{
			queryString= "Select TO_CHAR(SIGNING_DT,'DD/MM/YYYY'), TO_CHAR(START_DT,'DD/MM/YYYY') ," +
					...
					" MDCQ_PERCENTAGE, MEASUREMENT, MEAS_STANDARD, MEAS_TEMPERATURE, " +
					" PRESSURE_MIN_BAR, PRESSURE_MAX_BAR, OFF_SPEC_GAS, SPEC_GAS_ENERGY_BASE," +
					" SPEC_GAS_MIN_ENERGY, SPEC_GAS_MAX_ENERGY from DLNG_TENDER_MST  WHERE " +
					" TENDER_NO='"+tender_cd+"' AND CUSTOMER_CD='"+bscode+"' ";			
//			System.out.println("tender governing"+queryString);			
	...
	public void fetcg_SN_transporter_details()
	{
		try
		{
			queryString= "Select distinct(A.TRANSPORTER_CD) , B.STATION_ABBR  from DLNG_SN_TRANSPORTER_MST A , DLNG_SUPPLY_STATION_MST B WHERE " +
					"A.TRANSPORTER_CD = B.STATION_CD AND  A.FLSA_NO='"+FGSA_cd+"' AND A.FLSA_REV_NO = '"+FGSA_REVNo+"' AND A.CUSTOMER_CD='"+bscode+"' and A.SN_NO='"+SN_CD+"' and A.SN_REV_NO='"+SN_REVNo+"'  ";
//			System.out.println("Transporter details"+queryString);
	...
	public void fetch_LOA_transporter_details()
	{
		try
		{
			/*queryString= "Select distinct(A.TRANSPORTER_CD) , B.TRANSPORTER_ABBR  from DLNG_LOA_TRANSPORTER_MST A , " +
					"DLNG_TRANSPORTER_MST B WHERE A.TRANSPORTER_CD = B.TRANSPORTER_CD AND A.TENDER_NO='"+tender_cd+"'" +
					"AND A.CUSTOMER_CD='"+bscode+"' and A.LOA_NO='"+LOA_CD+"' and A.LOA_REV_NO='"+LOA_REVNo+"' ";*/
			queryString= "Select distinct(A.TRANSPORTER_CD) , B.STATION_ABBR  from DLNG_LOA_TRANSPORTER_MST A , " +
					"DLNG_SUPPLY_STATION_MST B WHERE A.TRANSPORTER_CD = B.STATION_CD AND A.TENDER_NO='"+tender_cd+"'" +
					"AND A.CUSTOMER_CD='"+bscode+"' and A.LOA_NO='"+LOA_CD+"' and A.LOA_REV_NO='"+LOA_REVNo+"' ";
			//System.out.println("Transporter details"+queryString);
			rset = stmt.executeQuery(queryString);
			while(rset.next())
	...
	public void fetch_FGSA_Transporter_Details_For_SN()
	{
		try
		{
			queryString= "Select distinct(A.TRANSPORTER_CD), B.STATION_ABBR  from DLNG_FLSA_TRANSPORTER_MST A, DLNG_SUPPLY_STATION_MST B WHERE " +
					"A.TRANSPORTER_CD=B.STATION_CD AND A.FLSA_NO='"+FGSA_cd+"' AND A.REV_NO='"+FGSA_REVNo+"' AND A.CUSTOMER_CD='"+bscode+"'";
//			System.out.println(queryString);
			rset = stmt.executeQuery(queryString);
			while(rset.next())
			{
	...
	public void fetch_Tender_Transporter_details()
	{
		try
		{
			/*queryString="Select distinct(A.TRANSPORTER_CD) , B.TRANSPORTER_ABBR  from DLNG_TENDER_TRANSPORTER_MST A, " +
			"FMS7_TRANSPORTER_MST B WHERE A.TRANSPORTER_CD = B.TRANSPORTER_CD AND  A.TENDER_NO='"+tender_cd+"'" +
			"AND A.CUSTOMER_CD='"+bscode+"' ";*/
			queryString="Select distinct(A.TRANSPORTER_CD) , B.STATION_ABBR  from DLNG_TENDER_TRANSPORTER_MST A, " +
					"DLNG_SUPPLY_STATION_MST B WHERE A.TRANSPORTER_CD = B.STATION_CD AND  A.TENDER_NO='"+tender_cd+"'" +
					"AND A.CUSTOMER_CD='"+bscode+"' ";
	...
	public void fetch_SN_Plant_details()
	{
		try
		{
			queryString= "Select PLANT_SEQ_NO  from DLNG_SN_PLANT_MST  WHERE " +
					" FLSA_NO='"+FGSA_cd+"' AND FLSA_REV_NO = '"+FGSA_REVNo+"' AND CUSTOMER_CD='"+bscode+"'   and SN_NO='"+SN_CD+"' and SN_REV_NO='"+SN_REVNo+"'  ";
//			System.out.println(queryString);
			rset = stmt.executeQuery(queryString);
			while(rset.next())
			{
...
//				System.out.println(queryString);
	...
	public void fetch_CustTrans_details(String MappID)
	{
		try
		{
			queryString= "Select TRANS_CD  from DLNG_CUST_TRANS_DTL  WHERE MAPPING_ID='"+MappID+"' " +
					" and FLAG='Y'  ";
//			System.out.println(queryString);
			rset = stmt.executeQuery(queryString);
			while(rset.next())
			{
				VCust_Trans_Cd.add(rset.getString(1)==null?"":rset.getString(1));
			}
		//	System.out.println(VCust_Trans_Cd);
		/*	for(int j=0;j<vPLANT_SEQ_NO.size();j++)
			{
				queryString= "Select PLANT_NAME from FMS7_CUSTOMER_PLANT_DTL A WHERE A.CUSTOMER_CD='"+bscode+"' AND " +
						"A.SEQ_NO='"+vPLANT_SEQ_NO.elementAt(j)+"' AND A.EFF_DT=(SELECT MAX(C.EFF_DT) FROM " +
	...
	public void fetch_LOA_Plant_details()
	{
		try
		{					
			queryString= "Select PLANT_SEQ_NO  from DLNG_LOA_PLANT_MST  WHERE " +
...
//			System.out.println("Customer Plant Fetch Query = "+queryString);
			...
			while(rset.next())
			{
				if(!rset.getString(2).equals(" ") && !rset.getString(3).equals(" "))
				{
					...
					queryString= "Select INR_MMBTU,INR_KM,LUMPSUM_FLAG  from DLNG_SN_PLANT_MST  WHERE " +
							" FLSA_NO='"+FGSA_cd+"' AND FLSA_REV_NO = '"+FGSA_REVNo+"' AND CUSTOMER_CD='"+bscode+"'"
							+ " and SN_NO='"+SN_CD+"' and SN_REV_NO='"+SN_REVNo+"' and PLANT_SEQ_NO = '"+rset.getString(1)+"' ";
//					System.out.println(queryString);
					rset1 = stmt1.executeQuery(queryString);
					if(rset1.next())
					{
						vsn_plant_inr_mmbtu.add(rset1.getString(1)==null?"":rset1.getString(1));
						vsn_plant_inr_km.add(rset1.getString(2)==null?"":rset1.getString(2));
						vsn_plant_lumpsum_flg.add(rset1.getString(3)==null?"":rset1.getString(3));
					}else {
						vsn_plant_inr_mmbtu.add("");
						vsn_plant_inr_km.add("");
						vsn_plant_lumpsum_flg.add("");
					}
				}
			}
			
			queryString= "Select PLANT_SEQ_NO from DLNG_FLSA_PLANT_MST WHERE " +
						 "FLSA_NO='"+FGSA_cd+"' AND REV_NO='"+FGSA_REVNo+"' AND CUSTOMER_CD='"+bscode+"'";
			//System.out.println(queryString);
			rset = stmt.executeQuery(queryString);
			while(rset.next())
		...
		{	
			...
			while(rset.next())
			{
				if(!rset.getString(2).equals(" ") && !rset.getString(3).equals(" "))
				{
					...
					queryString= "Select INR_MMBTU,INR_KM,LUMPSUM_FLAG  from DLNG_LOA_PLANT_MST  WHERE " +
							" TENDER_NO='"+tender_cd+"'  AND CUSTOMER_CD='"+bscode+"'"
							+ " and LOA_NO='"+LOA_CD+"' and LOA_REV_NO='"+LOA_REVNo+"' and PLANT_SEQ_NO = '"+rset.getString(1)+"' ";
//					System.out.println(queryString);
					rset1 = stmt1.executeQuery(queryString);
					if(rset1.next())
					{
			...
			queryString= "Select PLANT_SEQ_NO  from DLNG_TENDER_PLANT_MST  WHERE " +
						 "TENDER_NO='"+tender_cd+"'AND CUSTOMER_CD='"+bscode+"' ";
			//System.out.println(queryString);
			rset = stmt.executeQuery(queryString);
			while(rset.next())
	...
	{	
		try
		{
			queryString = "SELECT TO_CHAR(SIGNING_DT,'DD/MM/YYYY'),TO_CHAR(RENEWAL_DT,'DD/MM/YYYY'), " +
					...
					+ "NVL(SPLIT_TCQ_FLAG,'N'),DCQ_MT,TCQ_MT,FORMULA_REMARK, SN_BASE,PRICE_REQUEST_FLAG,CURRENCY_CD,"
					+ "TO_CHAR(DEAL_ENT_DT,'DD/MM/YYYY HH24:MI'),SIGNING_TIME,DEAL_ENT_BY,TO_CHAR(ENT_DT,'DD/MM/YYYY HH24:MI'),"
					+ " TO_CHAR(DDA_DT,'DD/MM/YYYY'),DDA_TIME "+ //DEAL_ENT_BY,DEAL_ENT_DT & SIGNING_TIME ADDED BY HARSH20211028
					"FROM DLNG_SN_MST WHERE SN_NO='"+SN_CD+"' AND " +
					"SN_REV_NO='"+SN_REVNo+"' AND CUSTOMER_CD='"+bscode+"' AND " +
					"FLSA_NO='"+FGSA_cd+"' AND FLSA_REV_NO = '"+FGSA_REVNo+"'";			
//			System.out.println("SN Master Query = "+queryString);
			...
			if(rset.next())
			{
				...
				MT =  rset.getString(68)==null?"":rset.getString(68);
				DCQ_MT = rset.getString(67)==null?"":rset.getString(67);
/*				System.out.println("DCQ_MT 2: "+ rset.getString(67)==null?"":rset.getString(67));
				System.out.println("MT 2: "+ rset.getString(68)==null?"":rset.getString(68));*/
			...
			//	System.out.println("In DataBean--> Rate"+rate);
				...
				{
					trans_charge = nf.format(Double.parseDouble(trans_charge));
				}
				...
				price_req_flag = rset.getString(71)==null?"":rset.getString(71);
...
//				SALES_RATE_INR=temprate;
				FORMULA_REMARK = rset.getString(69)==null?"":rset.getString(69); //SB20200717 
				SN_BASE = rset.getString(70)==null?"":rset.getString(70); //SB20200717 
				adv_cur_flg = rset.getString(72)==null?"":rset.getString(72); //Hiren_20210303
				
				//HARSH20211028
				String ent_dt_time = rset.getString(73)==null?"":rset.getString(73);
				String ent_dt = rset.getString(76)==null?"":rset.getString(76);
				DDA_Dt = rset.getString(77)==null?"":rset.getString(77);
				DDA_Dt_Tm = rset.getString(78)==null?"":rset.getString(78);
				
				if(!ent_dt_time.equals(""))
				{
					String split[] = ent_dt_time.split(" ");
					DEAL_ENT_DT = split[0];
					DEAL_ENT_TIME = split[1];
				}
				else if(!ent_dt.equals(""))
				{
					String split[] = ent_dt.split(" ");
					DEAL_ENT_DT = split[0];
					DEAL_ENT_TIME = split[1];
				}
				else
				...
				SIGNING_TIME=rset.getString(74)==null?"":rset.getString(74);
				DEAL_ENT_BY=rset.getString(75)==null?"":rset.getString(75);
				///////////////
				
				//FETCHING INVOICE DETAILS
				String query = "SELECT COUNT(HLPL_INV_SEQ_NO) FROM DLNG_INVOICE_MST WHERE SN_NO='"+SN_CD+"' AND FGSA_NO='"+FGSA_cd+"' AND CUSTOMER_CD='"+bscode+"' AND CONTRACT_TYPE='S' ";
//				System.out.println("Fetching details--"+query);
			...
			queryString="SELECT COUNT(NOM_DT) FROM DLNG_DAILY_NOM WHERE CONTRACT_TYPE='S' "
					+ "AND MAPPING_ID like '"+bscode+"-"+FGSA_cd+"-%-"+SN_CD+"-%' ";
//			System.out.println("count_price****"+queryString);
			rset=stmt.executeQuery(queryString);
			if(rset.next()){
			...
			//RG20200129
			queryString="SELECT FLSA_BASE FROM DLNG_FLSA_MST WHERE FLSA_NO='"+FGSA_cd+"' AND REV_NO='"+FGSA_REVNo+"' AND CUSTOMER_CD='"+bscode+"'";
			rset=stmt.executeQuery(queryString);
			if(rset.next()){
					...
					if(FGSA_cd!=null && !FGSA_cd.equals("") && !FGSA_cd.equals(" "))
					{
						if(FGSA_REVNo!=null && !FGSA_REVNo.equals("") && !FGSA_REVNo.equals(" "))
						{
							queryString = "SELECT SN_REF_NO " +
										  "FROM DLNG_SN_MST WHERE SN_NO='"+(Integer.parseInt(SN_CD)-1)+"' AND " +
										  "CUSTOMER_CD='"+bscode+"' AND " +
										  "FLSA_NO='"+FGSA_cd+"' AND SN_REF_NO IS NOT NULL";
							...
							allocated_qty = 0;
							queryString = "SELECT NVl(SUM(EXIT_TOT_ENE),0) FROM DLNG_ALLOC_MST WHERE "
									+ " PARTY_CD="+bscode+""
									+ " AND MAPPING_ID LIKE '"+bscode+"-"+FGSA_cd+"-0-"+SN_CD+"-%'"
									+ " AND CONTRACT_TYPE='S'";	
...
//							System.out.println("SN Already Allocated QTY Query = "+queryString);
							...
							if(rset.next())
							{
								if(rset.getString(1)!=null)
								{
									...
									{
										allocated_qty = rset.getDouble(1);
									}
								}
							}
...
//							System.out.println("DR SUM QTY----------"+queryString);
							...
							/*Hiren_20210217 include cr Quantity Change Criteria*/
							queryString = "SELECT nvl(SUM(DIFF_QTY),0) FROM DLNG_DR_CR_NOTE WHERE "
									+ " CUSTOMER_CD='"+bscode+"'"
									+ " AND FGSA_NO = '"+FGSA_cd+"'"
									+ " AND SN_NO = '"+SN_CD+"'"
...
//							System.out.println("CR SUM QTY----------"+queryString);
							...
							ALLOCATED_QTY = nf.format((allocated_qty + DEBIT_QTY) - CREDIT_QTY);
							
							int cnt = 0;
							queryString = "SELECT COUNT(CUSTOMER_CD) FROM DLNG_SN_DCQ_DTL WHERE " +
										  "SN_NO="+SN_CD+" AND CUSTOMER_CD="+bscode+" AND " +
										  "FLSA_NO="+FGSA_cd+" AND SN_REV_NO="+SN_REVNo+" AND " +
							...
							queryString = "SELECT B.REMARK " +
										  "FROM DLNG_SN_CARGO_DTL A, FMS7_MAN_CONFIRM_CARGO_DTL B " +
	...
	{	
		try
		{
			queryString = "select TO_CHAR(SIGNING_DT,'DD/MM/YYYY'), TO_CHAR(RENEWAL_DT,'DD/MM/YYYY')," +
					...
					+ "TCQ_MT,FORMULA_REMARK,LOA_BASE,PRICE_REQUEST_FLAG,CURRENCY_CD,TCQ_REQUEST_FLAG,"
					+ "TO_CHAR(DEAL_ENT_DT,'DD/MM/YYYY HH24:MI'),SIGNING_TIME,DEAL_ENT_BY,TO_CHAR(ENT_DT,'DD/MM/YYYY HH24:MI'),"
					+ "TO_CHAR(DDA_DT,'DD/MM/YYYY'), DDA_TIME "+ //DEAL_ENT_DT & SIGNING_TIME ADDED BY HARSH20211028
					"from DLNG_LOA_MST " +
					" where LOA_NO='"+LOA_CD+"' and LOA_REV_NO='"+LOA_REVNo+"' AND CUSTOMER_CD='"+bscode+"' AND" +
					" Tender_NO='"+tender_cd+"'";
//			System.out.println("loAQuery String-----"+queryString);
			rset = stmt.executeQuery(queryString);		
			if(rset.next())
			{
				SIGNING_DT  		=rset.getString(1)==null?"":rset.getString(1);
				...
				dcq_mt = rset.getString(60)==null?"0":rset.getString(60);
				tcq_mt = rset.getString(61)==null?"0":rset.getString(61);
...
//				}
//				SALES_RATE_INR=temprate;
				FORMULA_REMARK = rset.getString(62)==null?"":rset.getString(62); //SB20200717 	
				LOA_BASE = rset.getString(63)==null?"":rset.getString(63); //SB20200717
				price_req_flag = rset.getString(64)==null?"":rset.getString(64); 
				adv_cur_flg = rset.getString(65)==null?"":rset.getString(65); //Hiren_20210304
				tcq_req_flag = rset.getString(66)==null?"N":rset.getString(66); //Hiren_20210308
				
				//HARSH20211028
				String ent_dt_time = rset.getString(67)==null?"":rset.getString(67);
				String ent_dt = rset.getString(70)==null?"":rset.getString(70);
			
				DDA_Dt = rset.getString(71)==null?"":rset.getString(71);
				DDA_Dt_Tm = rset.getString(72)==null?"":rset.getString(72);
				...
				SIGNING_TIME=rset.getString(68)==null?"":rset.getString(68);
				DEAL_ENT_BY=rset.getString(69)==null?"":rset.getString(69);
				///////////////
				
				//FETCHING INVOICE DETAILS
				invoiceFlag = false;
				String query = "SELECT COUNT(HLPL_INV_SEQ_NO) FROM DLNG_INVOICE_MST WHERE SN_NO='"+LOA_CD+"' AND FGSA_NO='"+tender_cd+"' AND CUSTOMER_CD='"+bscode+"' AND CONTRACT_TYPE='L' ";
//				System.out.println("Fetching details--"+query);
				rset = stmt.executeQuery(query);
				if(rset.next()) {
					int count = rset.getInt(1);
			...
			queryString="SELECT COUNT(NOM_DT) FROM DLNG_DAILY_NOM WHERE CONTRACT_TYPE='S' "
					+ "AND MAPPING_ID like '"+bscode+"-"+tender_cd+"-%-"+SN_CD+"-%' ";
//			System.out.println("count_price****"+queryString);
			rset=stmt.executeQuery(queryString);
			if(rset.next()){
				count_price = rset.getInt(1);
			...
			queryString="SELECT TENDER_BASE FROM DLNG_TENDER_MST WHERE TENDER_NO='"+tender_cd+"' AND CUSTOMER_CD='"+bscode+"'";
			rset=stmt.executeQuery(queryString);
			if(rset.next()){
				agreement_base=rset.getString(1)==null?"":rset.getString(1);
			}
				...
				if(bscode!=null && !bscode.equals("") && !bscode.equals(" "))
				{
					if(tender_cd!=null && !tender_cd.equals("") && !tender_cd.equals(" "))
					{
						queryString = "SELECT LOA_REF_NO " +
									  "FROM DLNG_LOA_MST WHERE LOA_NO='"+(Integer.parseInt(LOA_CD)-1)+"' AND " +
									  "CUSTOMER_CD='"+bscode+"' AND " +
						...
						queryString = "SELECT nvl(SUM(EXIT_TOT_ENE),0) FROM DLNG_ALLOC_MST WHERE "
						+ " PARTY_CD="+bscode+""
						+ " AND MAPPING_ID LIKE '"+bscode+"-"+tender_cd+"-0-"+LOA_CD+"-%'"
						+ " AND CONTRACT_TYPE='L'";	
//						System.out.println("LOA Already Allocated QTY Query = "+queryString);
						rset = stmt.executeQuery(queryString);			
						if(rset.next())
...
//						System.out.println("CR SUM QTY----------"+queryString);
						...
						int cnt = 0;
						queryString = "SELECT COUNT(CUSTOMER_CD) FROM DLNG_LOA_DCQ_DTL WHERE LOA_NO="+LOA_CD+" AND " +
	...
	{		
		try 
		{
			...
			queryString ="Select TRANSPORTER_CD from FMS7_Tender_TRANSPORTER_MST where CUSTOMER_CD='"+bscode+"' and  Tender_NO='"+tender_cd+"' and FLAG='Y' ";
			//System.out.println("fetch Tender_TRANSPORTER_MST Query  : "+queryString);
			rset = stmt.executeQuery(queryString);
			while(rset.next())
			{
			...
			queryString ="Select PLANT_SEQ_NO from FMS7_Tender_PLANT_MST where CUSTOMER_CD='"+bscode+"' and  Tender_NO='"+tender_cd+"' and FLAG='Y'";
			...
			queryString ="Select CLAUSE_CD, REMARK from FMS7_Tender_CLAUSE_MST where CUSTOMER_CD='"+bscode+"' and  Tender_NO='"+tender_cd+"' ";
		...
		{			
			if(bscode!=null && !bscode.trim().equals("") && !bscode.trim().equals("0"))
			{
				queryString="SELECT distinct CUSTOMER_CD,TENDER_NO FROM "
						+ "FMS7_Tender_MST WHERE CUSTOMER_CD='"+bscode+"' "
			...
			else
			{
				if(Customer_access_flag.equals("Y"))
				{
					queryString="SELECT distinct A.CUSTOMER_CD,TENDER_NO FROM FMS7_Tender_MST A,SEC_EMP_CUSTOMER_ALLOC_MST B "
							+ "WHERE B.CUSTOMER_CD=A.CUSTOMER_CD AND B.EMP_CD='"+Emp_cd+"' "
							+ "ORDER BY A.customer_cd,TENDER_NO";
				} else {
					queryString="SELECT distinct CUSTOMER_CD,TENDER_NO FROM FMS7_Tender_MST A "
							+ "ORDER BY customer_cd,TENDER_NO";
				}
			}
			//System.out.println("FGSA Distinct Query = "+queryString);
			rset = stmt.executeQuery(queryString);
			while(rset.next())
			{
				if(!rset.getString(1).equals(" ") && !rset.getString(2).equals(" "))
		...
		try 
		{
			...
			else
			{
				if(Customer_access_flag.equals("Y"))
				{
					queryString="SELECT DISTINCT A.customer_cd,fgsa_no "
							+ "FROM FMS7_FGSA_MST A, SEC_EMP_CUSTOMER_ALLOC_MST B WHERE "
							+ "A.CUSTOMER_CD=B.CUSTOMER_CD AND B.EMP_CD='"+Emp_cd+"' "
							+ "ORDER BY A.customer_cd,fgsa_no";
				} else {
					queryString="SELECT DISTINCT customer_cd,fgsa_no FROM FMS7_FGSA_MST "
							+ "ORDER BY customer_cd,fgsa_no";
				}
			}
			rset = stmt.executeQuery(queryString);
			...
			for(int i=0;i<FGSA_no.size();i++)
			{
				queryString = "SELECT customer_cd, fgsa_no, TO_CHAR(start_dt,'dd/mm/yyyy'), " +
							  ...
							  "FROM FMS7_FGSA_MST WHERE customer_cd="+buyer_cd.elementAt(i)+" AND " +
							  "fgsa_no="+FGSA_no.elementAt(i)+" AND rev_no="+vRev_No.elementAt(i)+"";
				//System.out.println("FGSA Fetch DATA Query = "+queryString);
				rset = stmt.executeQuery(queryString);
				if(rset.next())
				{
					vSTART_DT.add(rset.getString(3)==null?"":rset.getString(3));
				...
				while(rset1.next())
				{
					...
					else if(rset1.getString(3).equalsIgnoreCase("L"))
					{
						queryString2 = "SELECT A.LOA_NO, A.LOA_REV_NO, A.CUSTOMER_CD, A.TENDER_NO, A.TCQ, D.UNIT_ABR, A.RATE, A.RATE_UNIT, "+
									  ...
									  "from DLNG_LOA_MST A, FMS7_CUSTOMER_MST C , FMS7_UNIT_MST D WHERE A.FLAG='T' " +
		...
		try 
		{
			...
			while(rset.next())	
			{
				queryString = "SELECT A.LOA_NO, A.LOA_REV_NO, A.CUSTOMER_CD, A.TENDER_NO, A.TCQ, D.UNIT_ABR, A.RATE, A.RATE_UNIT, "+
							  ...
							  "AND A.LOA_REV_NO=(SELECT MAX(A.LOA_REV_NO) FROM DLNG_LOA_MST B WHERE A.LOA_NO=B.LOA_NO "+
...
//			System.out.println("Customer_access_flag***"+Customer_access_flag);
			if(bscode!=null && !bscode.trim().equals("") && !bscode.trim().equals("0"))
			{
				queryString = "SELECT A.SN_NO, A.SN_REV_NO, A.CUSTOMER_CD, A.FLSA_NO, A.FLSA_REV_NO, " +
				"A.TCQ, D.UNIT_ABR, A.RATE, A.RATE_UNIT,C.CUSTOMER_NAME, C.CUSTOMER_ABBR, A.SN_NAME, " +
				"A.VERIFY_FLAG, A.FCC_FLAG, A.SN_REF_NO,TO_CHAR(A.START_DT,'DD/MM/YYYY'),TO_CHAR(A.END_DT,'DD/MM/YYYY') FROM DLNG_SN_MST A, FMS7_CUSTOMER_MST C, " +
				"FMS7_UNIT_MST D WHERE A.FLAG='T' AND A.SN_REV_NO=(SELECT MAX(B.SN_REV_NO) FROM " +
				"DLNG_SN_MST B WHERE A.SN_NO=B.SN_NO AND A.FLSA_NO=B.FLSA_NO AND A.FLSA_REV_NO=B.FLSA_REV_NO " +
				"AND B.FLAG='T' AND A.CUSTOMER_CD=B.CUSTOMER_CD) AND A.CUSTOMER_CD=C.CUSTOMER_CD AND A.CUSTOMER_CD='"+bscode+"' AND " +
				"C.EFF_DT=(SELECT MAX(E.EFF_DT) FROM FMS7_CUSTOMER_MST E WHERE E.CUSTOMER_CD=A.CUSTOMER_CD) " +
				"AND A.STATUS='Y' AND A.QUANTITY_UNIT=D.UNIT_CD " +
//	Hiren_20201212			" AND A.END_DT >=SYSDATE "+ //SB2020402
				"ORDER BY A.customer_cd,A.flsa_no,A.flsa_rev_no,A.sn_no";
//				System.out.println("1.Fetching SN List = "+queryString);
			}
			else
			{
				if(Customer_access_flag.equals("Y"))
				{
					queryString = "SELECT A.SN_NO, A.SN_REV_NO, A.CUSTOMER_CD, A.FLSA_NO, A.FLSA_REV_NO, " +
							...
							"FMS7_UNIT_MST D, SEC_EMP_CUSTOMER_ALLOC_MST E "
							+ "WHERE A.FLAG='T' AND A.SN_REV_NO=(SELECT MAX(B.SN_REV_NO) FROM " +
							"FMS7_SN_MST B WHERE A.SN_NO=B.SN_NO AND A.FLSA_NO=B.FLSA_NO AND A.FLSA_REV_NO=B.FLSA_REV_NO " +
							"AND B.FLAG='T' AND A.CUSTOMER_CD=B.CUSTOMER_CD) AND A.CUSTOMER_CD=C.CUSTOMER_CD AND " +
							"C.EFF_DT=(SELECT MAX(E.EFF_DT) FROM FMS7_CUSTOMER_MST E WHERE E.CUSTOMER_CD=A.CUSTOMER_CD) " +
...
//							"Hiren_20201212 AND A.END_DT >=SYSDATE "+ //SB2020402
							"ORDER BY A.customer_cd,A.flsa_no,A.flsa_rev_no,A.sn_no";
//					System.out.println("2.Fetching SN List = "+queryString);
				} else {
					queryString = "SELECT A.SN_NO, A.SN_REV_NO, A.CUSTOMER_CD, A.FLSA_NO, A.FLSA_REV_NO, " +
							"A.TCQ, D.UNIT_ABR, A.RATE, A.RATE_UNIT,C.CUSTOMER_NAME, C.CUSTOMER_ABBR, A.SN_NAME, " +
							"A.VERIFY_FLAG, A.FCC_FLAG, A.SN_REF_NO,TO_CHAR(A.START_DT,'DD/MM/YYYY'),TO_CHAR(A.END_DT,'DD/MM/YYYY') FROM DLNG_SN_MST A, FMS7_CUSTOMER_MST C, " +
...
//							"Hiren_20201212 AND A.END_DT >=SYSDATE "+ //SB2020402
							"ORDER BY A.customer_cd,A.flsa_no,A.flsa_rev_no,A.sn_no";
//					System.out.println("3.Fetching SN List = "+queryString);
				}		
			}
			System.out.println("Query For Fetching SN List = "+queryString);
			rset1 = stmt.executeQuery(queryString);
			while(rset1.next())
			{
				...
				vSN_approve.add(rset1.getString(14)==null?"":rset1.getString(14));
				String sn_ref_no = rset1.getString(15)==null?"":rset1.getString(15);
				vStartDt.add(rset1.getString(16)==null?"":rset1.getString(16));
				vEndDt.add(rset1.getString(17)==null?"":rset1.getString(17));
				if(!sn_ref_no.trim().equals(""))
				{
					vSN_Ref_No.add(" - ("+sn_ref_no+")");
				}
...
//			System.out.println(vSN_No.size()+"    :1 value of bscode: "+bscode);
			int SN_no=vSN_No.size()+1; int FLSANo=1;
			if(vSN_No.size()==0)
				FLSANo=1;		
		if(vSN_No.size()>=0)
			{
				...
				/*
				 * vSN_No.add(""+SN_no); vSN_rev_No.add("0"); buyer_cd.add(""+bscode);
				 * FGSA_no.add(""+FLSANo); vRev_No.add("0"); vSN_TCQ.add("0");
				 * vTCQ_UNIT.add(""); vSN_RATE.add("0"); vRATE_UNIT.add(""); buyer_nm.add("*");
				 * vBUYER_ABBR.add(""); vSN_name.add(""); vSN_verify.add("");
				 * vSN_approve.add(""); String sn_ref_no = ""; vStartDt.add(""); vEndDt.add("");
				 * vSN_Ref_No.add("");
				 */
//				System.out.println(vSN_No.size()+"    :2 value of bscode: "+bscode);
			}
			for(int i=0; i<FGSA_no.size(); i++)
			{
				...
				if(bscode!=null && !bscode.trim().equals("") && !bscode.trim().equals("0"))
				{
					queryString = "SELECT MAX(REV_NO) FROM DLNG_FLSA_MST WHERE FLSA_NO='"+FGSA_no.elementAt(i)+"' AND CUSTOMER_CD='"+bscode+"' ";
			//		System.out.println("FGSA-RevNo:A  "+queryString);
					...
					while(rset1.next())
					{
					   ...
					   else
					   {
						   vFGSA_Rev_No.add(rset1.getString(1));
						   	String query = "UPDATE DLNG_SN_MST SET FLSA_REV_NO='"+rset1.getString(1)+"' " +
						   		" WHERE FLSA_NO='"+FGSA_no.elementAt(i)+"' AND CUSTOMER_CD='"+bscode+"' AND SN_NO='"+vSN_No.elementAt(i)+"' ";
				...
				{
					queryString = "SELECT MAX(REV_NO) FROM DLNG_FLSA_MST WHERE FLSA_NO='"+FGSA_no.elementAt(i)+"' ";
		...
		{		
			...
			{			
				...
				vlapprv=vlapprv+(rset1.getString(13)==null?" ":rset1.getString(13))+"#";
					...
					" LOA_CLOSURE_REQUEST,LOA_CLOSURE_CLOSE,LOA_CLOSURE_FLAG,LOA_CLOSURE_QTY," +
					" TO_CHAR(LOA_CLOSURE_DT,'DD/MM/YYYY'),TCQ_REQUEST_SIGN,TCQ_REQUEST_QTY,FCC_BY," +
					" TO_CHAR(FCC_DATE,'DD/MM/YYYY') from DLNG_LOA_MST " +
			...
			else
			{
				if(Customer_access_flag.equals("Y"))
				{
					...
					queryString = "SELECT A.LOA_NO,A.LOA_REV_NO,A.CUSTOMER_CD,A.TENDER_NO,A.TCQ,D.UNIT_ABR,A.RATE,"
							...
							+ "from DLNG_LOA_MST A,FMS7_CUSTOMER_MST C,FMS7_UNIT_MST D, SEC_EMP_PARTY_ALLOC_MST E "
							+ "WHERE A.FLAG='T' AND A.LOA_REV_NO=(SELECT MAX(B.LOA_REV_NO) FROM DLNG_LOA_MST B "
...
//				System.out.println("queryString*******"+queryString);
			...
			int LoA_no=vLOA_No.size()+1; int TenderNo=1;
			if(vLOA_No.size()==0)
				TenderNo=1;
			{/*
				vLOA_No.add(""+LoA_no);
...
/////////////////SB20130810: For Line Color//////////
	...
	public void fetchTruckTransportMst() 
	{
		try 
		{
			queryString = "SELECT NVL(TRANS_CD,'0'),NVL(TRANS_NAME,' '),NVL(TRANS_ABBR,' ') " +
					  "FROM DLNG_TRANS_MST WHERE flag !='N' ORDER BY TRANS_ABBR";
			...
			while(rset.next())
			{
				if(!rset.getString(2).equals(" ") && !rset.getString(3).equals(" "))
				{
					VTruck_Trans_Cd.add(rset.getString(1));
					VTruck_Trans_Nm.add(rset.getString(2));
					VTruck_Trans_Abr.add(rset.getString(3));
				}
			}
		}
		catch (Exception e)
	...
	public void fetchSupplyStation() 
	{
		try 
		{
			/*SB20200704 queryString = "SELECT NVL(transporter_cd,'0'),NVL(transporter_name,' '),NVL(transporter_abbr,' ') " +
			...
			System.out.println("DLNG_SUPPLY_STATION_MST = "+queryString);
			rset = stmt.executeQuery(queryString);
			while(rset.next())
			{
				if(!rset.getString(2).equals(" ") && !rset.getString(3).equals(" "))
	...
	public void fetchFGSAData() 
	{
		try 
		{
			...
			if(flag.equals("R")) {
				queryString ="Select to_char(SIGNING_DT,'dd/mm/yyyy'), to_char(START_DT,'dd/mm/yyyy'), " +
						"to_char(END_DT,'dd/mm/yyyy'), FGSA_BASE, FGSA_TYPE, STATUS, BUYER_NOM, BUYER_MONTH_NOM, " +
						...
						"FROM " +
						"FMS7_FGSA_MST WHERE CUSTOMER_CD='"+bscode+"' and  FGSA_NO='"+FGSA_cd+"' and FLAG='Y' AND " +
						"REV_NO='"+rev_no+"' ";
			} else {
			queryString ="Select to_char(SIGNING_DT,'dd/mm/yyyy'), to_char(START_DT,'dd/mm/yyyy'), " +
						"to_char(END_DT,'dd/mm/yyyy'), FGSA_BASE, FGSA_TYPE, STATUS, BUYER_NOM, BUYER_MONTH_NOM, " +
						...
						"FROM " +
						"FMS7_FGSA_MST WHERE CUSTOMER_CD='"+bscode+"' and  FGSA_NO='"+FGSA_cd+"' and FLAG='Y' AND " +
						"REV_NO=(select max(rev_no) from FMS7_FGSA_MST where CUSTOMER_CD='"+bscode+"' AND " +
						"FGSA_NO='"+FGSA_cd+"' and FLAG='Y') ";
			}
			...
			queryString ="Select TRANSPORTER_CD from FMS7_FGSA_TRANSPORTER_MST where CUSTOMER_CD='"+bscode+"' and  FGSA_NO='"+FGSA_cd+"' and FLAG='Y' and REV_NO = (select max(rev_no) from FMS7_FGSA_MST where CUSTOMER_CD='"+bscode+"' and  FGSA_NO='"+FGSA_cd+"' and FLAG='Y') ";
			//System.out.println("fetch FGSA_TRANSPORTER_MST Query  : "+queryString);
			rset = stmt.executeQuery(queryString);
			while(rset.next())
			{
			...
			//FMS7_FGSA_PLANT_MST
			queryString ="Select PLANT_SEQ_NO from FMS7_FGSA_PLANT_MST where CUSTOMER_CD='"+bscode+"' and  FGSA_NO='"+FGSA_cd+"' and FLAG='Y' and REV_NO = (select max(rev_no) from FMS7_FGSA_MST where CUSTOMER_CD='"+bscode+"' and  FGSA_NO='"+FGSA_cd+"' and FLAG='Y') ";
			...
			queryString ="Select CLAUSE_CD, REMARK from FMS7_FGSA_CLAUSE_MST where BUYER_CD='"+bscode+"' and  FGSA_NO='"+FGSA_cd+"' and FLAG='Y' and REV_NO = (select max(rev_no) from FMS7_FGSA_MST where CUSTOMER_CD='"+bscode+"' and  FGSA_NO='"+FGSA_cd+"' and FLAG='Y') ";
	...
	public void fetchFGSADeactivationPeriod()
	{
		try
		{
			...
			queryString = "SELECT to_char(FROM_DT,'DD/MM/YYYY'), to_char(TO_DT,'DD/MM/YYYY'), STATUS FROM " +
					      "FMS7_FGSA_DEACTIVATION_DTL WHERE CUSTOMER_CD='"+bscode+"' " +
					      "AND  FGSA_NO='"+FGSA_cd+"' AND FGSA_REV_NO ='"+FGSA_REVNo+"' AND " +
			...
			else
			{
				queryString1 = "SELECT to_char(FROM_DT,'DD/MM/YYYY'), to_char(TO_DT,'DD/MM/YYYY'), STATUS FROM " +
						      "FMS7_FGSA_DEACTIVATION_DTL WHERE CUSTOMER_CD='"+bscode+"' " +
						      "AND  FGSA_NO='"+FGSA_cd+"' AND FGSA_REV_NO ='"+FGSA_REVNo+"' " +
						      "ORDER BY TO_DT desc";
			...
			queryString = "SELECT to_char(END_DT,'DD/MM/YYYY') FROM " +
		      "FMS7_FGSA_MST WHERE CUSTOMER_CD='"+bscode+"' " +
		      "AND  FGSA_NO='"+FGSA_cd+"' AND REV_NO ='"+FGSA_REVNo+"' AND END_DT<sysdate";
...
//			double hlpl_own_volume = Double.parseDouble(available_qty);
		   ...
		   queryString = "SELECT NVL(SUM(B.ALLOC_QTY),'0') FROM DLNG_LOA_MST A, FMS8_OWN_CARGO_DTL B "
	...
	public Vector getvStartDt() {return vStartDt;} //SB20200402
	public Vector getvEndDt() {return vEndDt;} //SB20200402
...
////Following (4) String Variables Has Been Defined By Jaimin Patel On 23rd Nov, 2011 ...
	...
	public void setDCQ_MT(String dCQ_MT) {
		DCQ_MT = dCQ_MT;
	}
	public String SN_BASE = "";
	public String adv_cur_flg = "";
	public String getSN_BASE() {return SN_BASE;}
	public String LOA_BASE = "";
	public String getLOA_BASE() {return LOA_BASE;}
	public Vector VTruck_Trans_Cd = new Vector();
	public Vector getVTruck_Trans_Cd() {return VTruck_Trans_Cd;}
	public Vector VTruck_Trans_Nm = new Vector();
	public Vector getVTruck_Trans_Nm() {return VTruck_Trans_Nm;}
	public Vector VTruck_Trans_Abr = new Vector();
	public Vector getVTruck_Trans_Abr() {return VTruck_Trans_Abr;}
	
	public Vector VCust_Trans_Cd = new Vector();
	public Vector getVCust_Trans_Cd() {return VCust_Trans_Cd;}

	public String getPrice_req_flag() {
		return price_req_flag;
	}

	public String getAdv_cur_flg() {
		return adv_cur_flg;
	}

	public void setAdv_cur_flg(String adv_cur_flg) {
		this.adv_cur_flg = adv_cur_flg;
	}

	public String getSECURITY_FLAG_SN() {
		return SECURITY_FLAG_SN;
	}

	public String getSECURITY_AMT_SN() {
		return SECURITY_AMT_SN;
	}

	public String getSECURITY_CUR_SN() {
		return SECURITY_CUR_SN;
	}

	public String getLUMPSUM_FLAG_SN() {
		return LUMPSUM_FLAG_SN;
	}

	public String getLUMPSUM_AMT_SN() {
		return LUMPSUM_AMT_SN;
	}

	public String getLUMPSUM_CUR_SN() {
		return LUMPSUM_CUR_SN;
	}

	public String getSECURITY_FLAG_LOA() {
		return SECURITY_FLAG_LOA;
	}

	public String getSECURITY_AMT_LOA() {
		return SECURITY_AMT_LOA;
	}

	public String getSECURITY_CUR_LOA() {
		return SECURITY_CUR_LOA;
	}

	public String getLUMPSUM_FLAG_LOA() {
		return LUMPSUM_FLAG_LOA;
	}

	public String getLUMPSUM_AMT_LOA() {
		return LUMPSUM_AMT_LOA;
	}

	public String getLUMPSUM_CUR_LOA() {
		return LUMPSUM_CUR_LOA;
	}

	public void setSECURITY_FLAG_SN(String sECURITY_FLAG_SN) {
		SECURITY_FLAG_SN = sECURITY_FLAG_SN;
	}

	public void setSECURITY_AMT_SN(String sECURITY_AMT_SN) {
		SECURITY_AMT_SN = sECURITY_AMT_SN;
	}

	public void setSECURITY_CUR_SN(String sECURITY_CUR_SN) {
		SECURITY_CUR_SN = sECURITY_CUR_SN;
	}

	public void setLUMPSUM_FLAG_SN(String lUMPSUM_FLAG_SN) {
		LUMPSUM_FLAG_SN = lUMPSUM_FLAG_SN;
	}

	public void setLUMPSUM_AMT_SN(String lUMPSUM_AMT_SN) {
		LUMPSUM_AMT_SN = lUMPSUM_AMT_SN;
	}

	public void setLUMPSUM_CUR_SN(String lUMPSUM_CUR_SN) {
		LUMPSUM_CUR_SN = lUMPSUM_CUR_SN;
	}

	public void setSECURITY_FLAG_LOA(String sECURITY_FLAG_LOA) {
		SECURITY_FLAG_LOA = sECURITY_FLAG_LOA;
	}

	public void setSECURITY_AMT_LOA(String sECURITY_AMT_LOA) {
		SECURITY_AMT_LOA = sECURITY_AMT_LOA;
	}

	public void setSECURITY_CUR_LOA(String sECURITY_CUR_LOA) {
		SECURITY_CUR_LOA = sECURITY_CUR_LOA;
	}

	public void setLUMPSUM_FLAG_LOA(String lUMPSUM_FLAG_LOA) {
		LUMPSUM_FLAG_LOA = lUMPSUM_FLAG_LOA;
	}

	public void setLUMPSUM_AMT_LOA(String lUMPSUM_AMT_LOA) {
		LUMPSUM_AMT_LOA = lUMPSUM_AMT_LOA;
	}

	public void setLUMPSUM_CUR_LOA(String lUMPSUM_CUR_LOA) {
		LUMPSUM_CUR_LOA = lUMPSUM_CUR_LOA;
	}

	public Vector getVsn_plant_inr_mmbtu() {
		return vsn_plant_inr_mmbtu;
	}

	public Vector getVsn_plant_inr_km() {
		return vsn_plant_inr_km;
	}

	public Vector getTAX_cform_flg() {
		return TAX_cform_flg;
	}
	...
	public Vector getTAX_Plant_cd() {
		return TAX_Plant_cd;
	}

	public Vector getVsn_plant_lumpsum_flg() {
		return vsn_plant_lumpsum_flg;
	}

	public String getTrans_cont_st_dt() {
		return trans_cont_st_dt;
	}

	public String getTrans_cont_end_dt() {
		return trans_cont_end_dt;
	}
	...
	public String getTrans_trucks_cnt() {
		return trans_trucks_cnt;
	}

	public String getTrans_total_qty() {
		return trans_total_qty;
	}

	public String getTrans_cont_sign_dt() {
		return trans_cont_sign_dt;
	}

	public String getTruck_fm() {
		return truck_fm;
	}

	public String getTruck_re() {
		return truck_re;
	}

	public String getQty_fm() {
		return qty_fm;
	}

	public String getQty_re() {
		return qty_re;
	}

	public String getTrans_cont_rad_flg() {
		return trans_cont_rad_flg;
	}
	
	
	String DEAL_ENT_DT=""; //HARSH20211028
	String DEAL_ENT_TIME=""; //HARSH20211028
	String SIGNING_TIME=""; //HARSH20211028
	String DEAL_ENT_BY=""; //HARSH20211028
	public String getDEAL_ENT_DT() {return DEAL_ENT_DT;} //HARSH20211028
	public String getDEAL_ENT_TIME() {return DEAL_ENT_TIME;} //HARSH20211028
	public String getSIGNING_TIME() {return SIGNING_TIME;} //HARSH20211028
	public String getDEAL_ENT_BY() {return DEAL_ENT_BY;} //HARSH20211028
