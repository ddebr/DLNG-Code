...
import com.sun.mail.util.BASE64EncoderStream; //changed by bhavana
import java.util.Properties;
import javax.mail.*;
import javax.mail.internet.*;
import javax.activation.*;
//import org.apache.commons.codec.binary.Base64; bhavana
...
public class EmailDelivery {
    ...
    public void setBody(String p_body) throws MessagingException {
        ...
        mbp_msgtext.setContent(p_body,"text/html");
    ...
    public void addFileAttachment1(String p_fileName,String path_img) throws MessagingException {
        MimeBodyPart mbp_file = new MimeBodyPart();
        ...
        mbp_file.setDataHandler(new DataHandler(fds));
        mbp_file.setFileName(fds.getName());
//        mbp_file.setContent(htmlText, "text/html");
        mp.addBodyPart(mbp_file);   
        //msg.setContent(mp);
        
        MimeBodyPart messageBodyPart = new MimeBodyPart();
        /*javax.activation.DataSource fds1 = new FileDataSource(path_img);

        messageBodyPart.setDataHandler(new DataHandler(fds1));
        messageBodyPart.setFileName(fds1.getName());
    ...
    public void addFileAttachmentFromStream(String p_fileName, 
        ...
        */
     //enc_b = Base64.encode()
      //  enc_b = Base64.encodeBase64(b);   by bhavana
        enc_b = BASE64EncoderStream.encode(b);
        ...
        hdr.addHeader("Content-Disposition", "ATTACHMENT; filename=\""+p_fileName+"\"");
    ...
    public void sendMsg() throws MessagingException {
        ...
        if (usingAuthentication) {
            ...
            System.out.println("smtp_host = "+smtp_host+", smtp_username = "+smtp_username+", smtp_password = "+smtp_password);
            //System.out.println("msg.getAllRecipients() = "+msg.getAllRecipients());
